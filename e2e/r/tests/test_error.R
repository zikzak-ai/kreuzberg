...
# alef:hash:44e4e416417a6fce0bb4e75a0d2c9f765e39f98ef1cc5488192eee14a901116f
...
test_that("error_empty_bytes: Graceful handling of empty bytes (should not error)", {
  result <- .maybe_decode_json(extract_bytes_sync(content = readBin(.resolve_fixture("text/empty.txt"), what = "raw", n = file.info(.resolve_fixture("text/empty.txt"))$size), mime_type = "text/plain", config = ExtractionConfig$default()))
})
