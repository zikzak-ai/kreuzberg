...
// alef:hash:bc4f322ecbde18929a03644720b5592cfbe5d123bc36aea2757dd24eab7a69c6
...
final class EmbedAsyncPendingTest extends TestCase
{
    ...
    {        $result = Kreuzberg::embedTextsAsync([], EmbeddingConfig::from_json('{}'));
    ...
    {        $result = Kreuzberg::embedTextsAsync(["First", "Second"], EmbeddingConfig::from_json('{}'));
