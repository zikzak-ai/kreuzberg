...
// alef:hash:bd17617e05cc5321a13c77c9868c3f7a3c2728741b328c4b701774e02cfd1b4a
...
final class AsyncTest extends TestCase
{
    ...
    {
        $result = Kreuzberg::extract_bytes_async("pdf/fake_memo.pdf", "application/pdf");
    ...
    public function test_async_extract_bytes_empty_mime(): void
    {
        ...
        Kreuzberg::extract_bytes_async("text/plain.txt", "", $config);
    }
    ...
    public function test_async_extract_bytes_invalid_mime(): void
    {
        $config = ExtractionConfig::from_json(json_encode([]));
        $this->expectException(\Exception::class);
        Kreuzberg::extract_bytes_async("text/plain.txt", "application/x-nonexistent", $config);
    }
}
