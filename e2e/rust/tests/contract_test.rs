...
// alef:hash:a1739c9d0a761f94d52c192d6a6810e043c243a92e8b42cf5b8a59d9fd3becaa
...
async fn test_api_batch_bytes_async() {
    ...
    for r in &result {
        assert_eq!(r.mime_type.trim(), r#"application/pdf"#, "equals assertion failed");
    }
    for r in &result {
        assert!(r.content.len() >= 10, "expected length >= 10, got {}", r.content.len());
    }
    for r in &result {
        assert!(
            r.content.contains(r#"May 5, 2023"#) || r.content.contains(r#"Mallori"#),
...
async fn test_api_batch_bytes_with_configs_async() {
    ...
    for r in &result {
        assert_eq!(r.output_format.trim(), r#"markdown"#, "equals assertion failed");
    }
}
