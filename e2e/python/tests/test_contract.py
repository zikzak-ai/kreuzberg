...
# alef:hash:0c0015dca1a752072528a0e034f0e3536346c19a65d7ad57bf5f0bced39d0b04
...
def test_config_document_structure() -> None:
    ...
    assert "paragraph" in result.document.node_types  # noqa: S101
...
def test_config_document_structure_groups() -> None:
    ...
    assert result.document  # noqa: S101
    assert any(v in result.document.node_types for v in ["group"])  # noqa: S101
...
def test_config_document_structure_headings() -> None:
    ...
    assert result.document  # noqa: S101
    assert len(result.document.nodes) >= 1  # noqa: S101
    assert "heading" in result.document.node_types  # noqa: S101
    assert "paragraph" in result.document.node_types  # noqa: S101
