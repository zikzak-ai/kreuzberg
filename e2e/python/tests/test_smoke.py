...
# alef:hash:4260c7f6f81ba6b15122cd7d53c1ec64acc04fb070d09fe09e96c65c0bc03517
# To regenerate: alef generate
# To verify freshness: alef verify --exit-code
# Issues & docs: https://github.com/kreuzberg-dev/alef

"""E2e tests for category: smoke."""from pathlib import Pathimport pytest  # noqa: F401from kreuzberg import extract_bytes, extract_file, ExtractionConfig
...
@pytest.mark.asyncio
def test_ocr_image_png() -> None:
    """OCR: PNG image extraction with OCR enabled. In WASM this exercises the Uint8Array bridge parameter and Promise await in the generated OcrBackend bridge."""    data = Path("images/test_hello_world.png").read_bytes()
    mime_type = "image/png"
...
def test_smoke_docx_basic() -> None:
    """Smoke test: DOCX with formatted text."""    path = "docx/fake.docx"
...
def test_smoke_html_basic() -> None:
    """Smoke test: HTML table extraction."""    path = "html/simple_table.html"
    mime_type = "text/html"
    config = ExtractionConfig()
    result = await extract_file(path=path, mime_type=mime_type, config=config)
...
def test_smoke_image_png() -> None:
    """Smoke test: PNG image (without OCR, metadata only)."""    path = "images/sample.png"
...
def test_smoke_json_basic() -> None:
    """Smoke test: JSON file extraction."""    path = "json/simple.json"
...
def test_smoke_pdf_basic() -> None:
    """Smoke test: PDF with simple text extraction."""    path = "pdf/fake_memo.pdf"
...
def test_smoke_txt_basic() -> None:
    """Smoke test: Plain text file."""    path = "text/report.txt"
...
def test_smoke_xlsx_basic() -> None:
    """Smoke test: XLSX with basic spreadsheet data including tables."""    path = "xlsx/stanley_cups.xlsx"
