...
# alef:hash:766396aa7c3f7b1d86668908a68548b716c617bcc88ead1e84e71f5b3b667f28
# To regenerate: alef generate
# To verify freshness: alef verify --exit-code
# Issues & docs: https://github.com/kreuzberg-dev/alef

"""E2e tests for category: registry."""import pytest  # noqa: F401from kreuzberg import list_document_extractors, list_ocr_backends, list_post_processors, list_validators
...
def test_list_document_extractors() -> None:
    """List document extractors."""    _ = list_document_extractors()

def test_list_ocr_backends() -> None:
    """List OCR backends."""    _ = list_ocr_backends()

def test_list_post_processors() -> None:
    """List post-processors."""    _ = list_post_processors()

def test_list_validators() -> None:
    """List validators."""    _ = list_validators()
