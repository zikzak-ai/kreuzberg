...
def test_bold_basic() -> None:
    ...
    assert "important" in result.result
...
def test_code_basic() -> None:
    ...
    assert "variable" in result.result
...
def test_italic_basic() -> None:
    ...
    assert "emphasis" in result.result
...
def test_link_basic() -> None:
    ...
    assert "Click here" in result.result
...
def test_underline_basic() -> None:
    ...
    assert "underlined" in result.result
