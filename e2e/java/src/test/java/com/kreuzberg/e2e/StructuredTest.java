...
public class StructuredTest {
    ...
    public void structuredEnwBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/x-endnote-refer", "application/x-endnote+xml", "text/plain"));
            }
        );
    }
    ...
    public void structuredNbibBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/nbib", "application/x-pubmed", "text/plain"));
    ...
    public void structuredRisBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/x-research-info-systems", "text/plain"));
                E2EHelpers.Assertions.assertContentNotEmpty(result);
            }
        );
    }
    ...
    public void structuredTsvBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("text/tab-separated-values", "text/plain"));
                E2EHelpers.Assertions.assertMinContentLength(result, 10);
            }
        );
    }
