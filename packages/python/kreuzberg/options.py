...
# alef:hash:0d29659408072c7e3fa0309950ad4de3c118d20dccf06fcb96b66fb80bc175d1
...
class Metadata:
    ...
    """Custom fields for plugin-injected and format-specific dynamic data (e.g., OCR backend metadata, org-mode directives)."""
...
class ArchiveMetadata:
    ...
    entries: list[ArchiveFileEntry] = field(default_factory=list)
