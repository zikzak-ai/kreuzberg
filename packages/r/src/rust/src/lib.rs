...
// alef:hash:f5640b9bcbecc48e2e7b76925f608d978f3d4f7f17e1e86c8ed8e830f01a7e20
...
pub fn new_extractionconfig(
    ...
    output_format: String = String$Plain,
...
impl EmbeddingConfig {
    ...
    pub fn new(
        ...
        Self { model: model.unwrap_or_default(), normalize: normalize.unwrap_or(true), batch_size: batch_size.unwrap_or(32), show_download_progress: show_download_progress.unwrap_or(false), cache_dir: cache_dir, acceleration: acceleration }
    }
...
impl LayoutRegion {
    ...
    pub fn new(
        ...
        Self { class: class.unwrap_or_default(), confidence: confidence.unwrap_or_default(), bounding_box: bounding_box.unwrap_or_default(), area_fraction: area_fraction.unwrap_or_default() }
    }
}
...
pub fn chunk_text(text: String, config: ChunkingConfig, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult> {
    ...
    kreuzberg::chunking::core::chunk_text(&text, &config_core, page_boundaries_core.as_deref()).map(|val| ChunkingResult::from(val)).map_err(|e| e.to_string())
}
