...
// alef:hash:039e95cecbfa2aae3930d51276b498c5d05fdd3aa00db249806ee2b713fcc810
...
pub fn new_metadata(
    ...
    if let Some(v) = extraction_method {
        __out.extraction_method = Some(v);
    }
...
#[extendr]
pub fn new_archivefileentry(path: Option<String>, size: Option<f64>, is_dir: Option<bool>) -> ArchiveFileEntry {
    let mut __out = <ArchiveFileEntry>::default();
    if let Some(v) = path {
        __out.path = v;
    }
    if let Some(v) = size {
...
pub struct FormatMetadata {
    ...
    pub structured: Option<StructuredMetadata>,
