...
// alef:hash:af535ac35e237e119d6af43c2e7db65f2b1674b4e979d11ed19e7b2d46154448
...
impl ImageExtractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
    Self {
        extract_images: opts.get("extract_images").and_then(|t| t.decode().ok()).unwrap_or_default(),
        target_dpi: opts.get("target_dpi").and_then(|t| t.decode().ok()).unwrap_or_default(),
        max_image_dimension: opts.get("max_image_dimension").and_then(|t| t.decode().ok()).unwrap_or_default(),
        inject_placeholders: opts.get("inject_placeholders").and_then(|t| t.decode().ok()).unwrap_or_default(),
        auto_adjust_dpi: opts.get("auto_adjust_dpi").and_then(|t| t.decode().ok()).unwrap_or_default(),
...
impl HeaderFooter {
    ...
    Self {
        ...
        header_type: opts.get("header_type").and_then(|t| t.decode().ok()).unwrap_or_default(),
    }
}
}
...
impl ExcelMetadata {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
    Self {
        sheet_count: opts.get("sheet_count").and_then(|t| t.decode().ok()).unwrap_or_default(),
        sheet_names: opts.get("sheet_names").and_then(|t| t.decode().ok()).unwrap_or_default(),
    }
}
}
...
impl WarmRequest {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
    Self {
        all_embeddings: opts.get("all_embeddings").and_then(|t| t.decode().ok()).unwrap_or_default(),
...
pub fn extract_bytes_async(content: Vec<u8>, mime_type: String, config: Option<String>) -> Result<ExtractionResult, String> {
...
pub fn extract_file_async(path: String, mime_type: Option<String>, config: Option<String>) -> Result<ExtractionResult, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
    let result = rt.block_on(async { kreuzberg::extract_file(path, mime_type.as_deref(), config_core.as_ref().unwrap_or(&Default::default())).await }).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn extract_file_sync(path: String, mime_type: Option<String>, config: Option<String>) -> Result<ExtractionResult, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::extract_file_sync(path, mime_type.as_deref(), config_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into())
}

#[rustler::nif]
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: Option<String>) -> Result<ExtractionResult, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::extract_bytes_sync(&content, &mime_type, config_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn batch_extract_file_sync(items: Vec<String>, config: Option<String>) -> Result<Vec<ExtractionResult>, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::batch_extract_file_sync(items, config_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
...
pub fn batch_extract_bytes_sync(items: Vec<String>, config: Option<String>) -> Result<Vec<ExtractionResult>, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::batch_extract_bytes_sync(items, config_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn batch_extract_file_async(items: Vec<String>, config: Option<String>) -> Result<Vec<ExtractionResult>, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
    let result = rt.block_on(async { kreuzberg::batch_extract_file(items, config_core.as_ref().unwrap_or(&Default::default())).await }).map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn batch_extract_bytes_async(items: Vec<String>, config: Option<String>) -> Result<Vec<ExtractionResult>, String> {
    let config_core: Option<kreuzberg::ExtractionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ExtractionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let rt = tokio::runtime::Runtime::new().map_err(|e| e.to_string())?;
    let result = rt.block_on(async { kreuzberg::batch_extract_bytes(items, config_core.as_ref().unwrap_or(&Default::default())).await }).map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
#[rustler::nif]
pub fn extract_email_content(data: Vec<u8>, mime_type: String, fallback_codepage: Option<u32>) -> Result<EmailExtractionResult, String> {
    let result = kreuzberg::extraction::email::extract_email_content(&data, &mime_type, fallback_codepage).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn reduce_tokens(text: String, config: Option<String>, language_hint: Option<String>) -> Result<String, String> {
    let config_core: Option<kreuzberg::TokenReductionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::TokenReductionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::text::reduce_tokens(&text, config_core.as_ref().unwrap_or(&Default::default()), language_hint.as_deref()).map_err(|e| e.to_string())?;
    Ok(result.into())
}

#[rustler::nif]
pub fn batch_reduce_tokens(texts: Vec<String>, config: Option<String>, language_hint: Option<String>) -> Result<Vec<String>, String> {
    let config_core: Option<kreuzberg::TokenReductionConfig> = config.map(|s| serde_json::from_str::<kreuzberg::TokenReductionConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::text::batch_reduce_tokens(&texts, config_core.as_ref().unwrap_or(&Default::default()), language_hint.as_deref()).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn create_string_buffer_pool(pool_size: usize, buffer_capacity: usize) -> ResourceArc<StringBufferPool> {
    ResourceArc::new(StringBufferPool { inner: Arc::new(kreuzberg::utils::pool::create_string_buffer_pool(pool_size, buffer_capacity)) })
}

#[rustler::nif]
pub fn create_byte_buffer_pool(pool_size: usize, buffer_capacity: usize) -> ResourceArc<ByteBufferPool> {
    ResourceArc::new(ByteBufferPool { inner: Arc::new(kreuzberg::utils::pool::create_byte_buffer_pool(pool_size, buffer_capacity)) })
}
...
#[rustler::nif]
pub fn chunk_text(text: String, config: Option<String>, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult, String> {
    let config_core: Option<kreuzberg::ChunkingConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ChunkingConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::chunking::chunk_text(&text, config_core.as_ref().unwrap_or(&Default::default()), &page_boundaries).map_err(|e| e.to_string())?;
    Ok(result.into())
}

#[rustler::nif]
pub fn chunk_text_with_heading_source(text: String, config: Option<String>, page_boundaries: Option<Vec<PageBoundary>>, heading_source: Option<String>) -> Result<ChunkingResult, String> {
    let config_core: Option<kreuzberg::ChunkingConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ChunkingConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::chunking::core::chunk_text_with_heading_source(&text, config_core.as_ref().unwrap_or(&Default::default()), &page_boundaries, heading_source.as_deref()).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn chunk_texts_batch(texts: Vec<String>, config: Option<String>) -> Result<Vec<ChunkingResult>, String> {
    let config_core: Option<kreuzberg::ChunkingConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ChunkingConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::chunking::core::chunk_texts_batch(&texts, config_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}

#[rustler::nif]
pub fn chunk_semantic(text: String, config: Option<String>, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult, String> {
    let config_core: Option<kreuzberg::ChunkingConfig> = config.map(|s| serde_json::from_str::<kreuzberg::ChunkingConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::chunking::semantic::chunk_semantic(&text, config_core.as_ref().unwrap_or(&Default::default()), &page_boundaries).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn warm_model(model_type: EmbeddingModelType, cache_dir: Option<String>) -> Result<(), String> {
    ...
    let result = kreuzberg::warm_model(&model_type_core, std::path::PathBuf::from(cache_dir)).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn download_model(model_type: EmbeddingModelType, cache_dir: Option<String>) -> Result<(), String> {
    let model_type_json = serde_json::to_string(&model_type).map_err(|e| e.to_string())?;
    let model_type_core: kreuzberg::EmbeddingModelType = serde_json::from_str(&model_type_json).map_err(|e| e.to_string())?;
    let result = kreuzberg::download_model(&model_type_core, std::path::PathBuf::from(cache_dir)).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn extract_keywords(text: String, config: Option<String>) -> Result<Vec<Keyword>, String> {
    let config_core: Option<kreuzberg::KeywordConfig> = config.map(|s| serde_json::from_str::<kreuzberg::KeywordConfig>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::extract_keywords(&text, config_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub fn render_pdf_page_to_png(pdf_bytes: Vec<u8>, page_index: usize, dpi: Option<i32>, password: Option<String>) -> Result<Vec<u8>, String> {
    let result = kreuzberg::pdf::rendering::render_pdf_page_to_png(&pdf_bytes, page_index, dpi, password.as_deref()).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn serialize_to_toon(result: Option<String>) -> Result<String, String> {
    let result_core: Option<kreuzberg::ExtractionResult> = result.map(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::serialize_to_toon(result_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
pub fn serialize_to_json(result: Option<String>) -> Result<String, String> {
    let result_core: Option<kreuzberg::ExtractionResult> = result.map(|s| serde_json::from_str::<kreuzberg::ExtractionResult>(&s)).transpose().map_err(|e| e.to_string())?;
    let result = kreuzberg::serialize_to_json(result_core.as_ref().unwrap_or(&Default::default())).map_err(|e| e.to_string())?;
    Ok(result.into())
}
...
impl kreuzberg::plugins::OcrBackend for RustlerOcrBackendBridge {
    async fn process_image(&self, image_bytes: &[u8], config: &kreuzberg::OcrConfig) -> std::result::Result<kreuzberg::ExtractionResult, kreuzberg::KreuzbergError> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            env.run(|env_ref| {
                ...
                let key = rustler::types::atom::Atom::from_str(env_ref, "process_image").ok()?;
                let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
                if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
                let args: Vec<rustler::Term> = vec![
                    image_bytes.encode(env_ref),
                    format!("{:?}", config).encode(env_ref),
                ];
    ...
    async fn process_image_file(&self, path: &std::path::Path, config: &kreuzberg::OcrConfig) -> std::result::Result<kreuzberg::ExtractionResult, kreuzberg::KreuzbergError> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            env.run(|env_ref| {
                let elixir_term = saved_term.load(env_ref);
                let key = rustler::types::atom::Atom::from_str(env_ref, "process_image_file").ok()?;
                let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
                if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
                let args: Vec<rustler::Term> = vec![
                    format!("{:?}", path).encode(env_ref),
                    format!("{:?}", config).encode(env_ref),
                ];
                let _result = env_ref.call(method_term, &args).ok()?;
                Some(serde_json::json!({}))
    ...
    fn supports_language(&self, lang: &str) -> bool {
        self.env.run(|env| {
            let elixir_term = self.inner.load(env);
            let key = rustler::types::atom::Atom::from_str(env, "supports_language").ok()?;
            let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
            if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
            let args: Vec<rustler::Term> = vec![
                lang.encode(env),
    ...
    fn backend_type(&self) -> kreuzberg::plugins::OcrBackendType {
        self.env.run(|env| {
            let elixir_term = self.inner.load(env);
            let key = rustler::types::atom::Atom::from_str(env, "backend_type").ok()?;
            let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
            if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
            let args: Vec<rustler::Term> = Vec::new();
            let result: rustler::Term = env.call(method_term, &args).ok()?;
    ...
    fn supported_languages(&self) -> Vec<String> {
        self.env.run(|env| {
            let elixir_term = self.inner.load(env);
            let key = rustler::types::atom::Atom::from_str(env, "supported_languages").ok()?;
            let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
            if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
            let args: Vec<rustler::Term> = Vec::new();
            let result: rustler::Term = env.call(method_term, &args).ok()?;
    ...
    fn supports_table_detection(&self) -> bool {
        self.env.run(|env| {
            let elixir_term = self.inner.load(env);
            let key = rustler::types::atom::Atom::from_str(env, "supports_table_detection").ok()?;
            let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
            if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
            let args: Vec<rustler::Term> = Vec::new();
            let result: rustler::Term = env.call(method_term, &args).ok()?;
    ...
    fn supports_document_processing(&self) -> bool {
        self.env.run(|env| {
            let elixir_term = self.inner.load(env);
            let key = rustler::types::atom::Atom::from_str(env, "supports_document_processing").ok()?;
            let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
            if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
            let args: Vec<rustler::Term> = Vec::new();
            let result: rustler::Term = env.call(method_term, &args).ok()?;
    ...
    async fn process_document(&self, _path: &std::path::Path, _config: &kreuzberg::OcrConfig) -> std::result::Result<kreuzberg::ExtractionResult, kreuzberg::KreuzbergError> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            env.run(|env_ref| {
                let elixir_term = saved_term.load(env_ref);
                let key = rustler::types::atom::Atom::from_str(env_ref, "process_document").ok()?;
                let method_term: rustler::Term = rustler::Term::map_get(elixir_term, key).ok()??;
                if method_term.atom_to_string().ok().as_deref() == Some("nil") { return None; }
                let args: Vec<rustler::Term> = vec![
                    format!("{:?}", _path).encode(env_ref),
                    format!("{:?}", _config).encode(env_ref),
                ];
                let _result = env_ref.call(method_term, &args).ok()?;
                Some(serde_json::json!({}))
            })
...
#[rustler::nif]
pub fn register_ocr_backend(env: rustler::Env<'_>, elixir_backend: rustler::Term<'_>) -> rustler::Atom {
    let required = ["process_image", "supports_language", "backend_type"];
    ...
    let bridge = RustlerOcrBackendBridge::new(env, elixir_backend);
...
pub fn tessdatamanager_cache_dir(resource: ResourceArc<TessdataManager>) -> String {
    resource.inner.as_ref().clone().cache_dir().to_string_lossy().to_string()
}
...
pub fn tessdatamanager_ensure_all_languages(resource: ResourceArc<TessdataManager>) -> Result<usize, String> {
    let result = resource.inner.as_ref().clone().ensure_all_languages().map_err(|e| e.to_string())?;
    Ok(result)
}
...
impl From<OcrElement> for kreuzberg::OcrElement {
    fn from(val: OcrElement) -> Self {
        Self {
            ...
            backend_metadata: val.backend_metadata.into_iter().map(|(k, v)| (k, serde_json::from_str(&v).unwrap_or_default())).collect(),
        }
    }
}
...
fn on_load(env: rustler::Env, _info: rustler::Term) -> bool {
    ...
    env.register::<StringGrowthValidator>().expect("Failed to register resource type StringGrowthValidator");
    env.register::<IterationValidator>().expect("Failed to register resource type IterationValidator");
    env.register::<DepthValidator>().expect("Failed to register resource type DepthValidator");
    env.register::<EntityValidator>().expect("Failed to register resource type EntityValidator");
    env.register::<TableValidator>().expect("Failed to register resource type TableValidator");
    ...
    env.register::<PdfUnifiedExtractionResult>().expect("Failed to register resource type PdfUnifiedExtractionResult");
    true
}
