...
// alef:hash:2aca7aa4250a93eda3e0dc10bd6d4c62b9f716e0b09ad62d008eaac2de41da72
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            attachments: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            extra_headers: opts.get("extra_headers").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl ArchiveFileEntry {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            is_dir: opts.get("is_dir").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl ArchiveMetadata {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            entries: opts.get("entries").and_then(|t| t.decode().ok()).unwrap_or_default(),
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            field_count: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            custom_fields: opts.get("custom_fields").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl BibtexMetadata {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            entries: opts.get("entries").and_then(|t| t.decode().ok()),
        }
    }
}
