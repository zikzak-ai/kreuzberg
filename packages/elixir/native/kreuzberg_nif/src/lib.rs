...
// alef:hash:9b5a51feabbadbfa1ba910164bd5dc5e3c91031617cd5f3ab011f8bee50ae757
...
pub fn chunk_text(text: String, config: Option<String>, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult, String> {
    ...
    let result = kreuzberg::chunking::core::chunk_text(&text, config_core.as_ref().unwrap_or(&Default::default()), &page_boundaries).map_err(|e| e.to_string())?;
    Ok(result.into())
}
