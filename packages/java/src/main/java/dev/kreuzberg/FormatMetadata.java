...
// alef:hash:9f2f9de1872916a23282bcccdac3027f2fa4a21b55f1136d30d3877ff4f5f7f4
...
@JsonSubTypes({@JsonSubTypes.Type(value = FormatMetadata.Pdf.class, name = "pdf"),
        ...
        @JsonSubTypes.Type(value = FormatMetadata.Structured.class, name = "structured"),
...
public sealed interface FormatMetadata {
    ...
    record Structured(@JsonUnwrapped StructuredMetadata value) implements FormatMetadata {
    }
    ...
    /** Returns the Structured data if this is a Structured variant, otherwise null. */
    default @Nullable StructuredMetadata structured() {
        return this instanceof Structured e ? e.value() : null;
    }
