...
// alef:hash:98d9455a250a13ce2716cf3cb8ac91d8893dc8063c235f6bfdbb33886430c885
...
public record HtmlMetadata(
    ...
    public static final class Builder {
        ...
        private Map<String, String> openGraph = /* serde(default) */;
        @JsonProperty("twitter_card")
        private Map<String, String> twitterCard = /* serde(default) */;
        @JsonProperty("meta_tags")
        private Map<String, String> metaTags = /* serde(default) */;
        private List<HeaderMetadata> headers = /* serde(default) */;
        private List<LinkMetadata> links = /* serde(default) */;
        private List<ImageMetadataType> images = /* serde(default) */;
        @JsonProperty("structured_data")
        private List<StructuredData> structuredData = /* serde(default) */;
