...
// alef:hash:7e51eb645709cd16349dc240c55bc268e09c4c0d255d773c8f9811a5aab970c6
...
public record ExtractionResult(
    ...
    public static final class Builder {
        ...
        private Optional<ExtractionMethod> extractionMethod = Optional.of(/* serde(default) */);
        ...
        private Optional<List<Element>> elements = Optional.of(/* serde(default) */);
        @JsonProperty("djot_content")
        private Optional<DjotContent> djotContent = Optional.of(/* serde(default) */);
        @JsonProperty("ocr_elements")
        private Optional<List<OcrElement>> ocrElements = Optional.of(/* serde(default) */);
        private Optional<DocumentStructure> document = Optional.of(/* serde(default) */);
        @JsonProperty("extracted_keywords")
        private Optional<List<Keyword>> extractedKeywords = Optional.of(/* serde(default) */);
        @JsonProperty("quality_score")
        private Optional<Double> qualityScore = Optional.of(/* serde(default) */);
        @JsonProperty("processing_warnings")
        private List<ProcessingWarning> processingWarnings = /* serde(default) */;
        private Optional<List<PdfAnnotation>> annotations = Optional.of(/* serde(default) */);
        private Optional<List<ArchiveEntry>> children = Optional.of(/* serde(default) */);
        private Optional<List<Uri>> uris = Optional.of(/* serde(default) */);
        @JsonProperty("structured_output")
        private Optional<Object> structuredOutput = Optional.of(/* serde(default) */);
        @JsonProperty("code_intelligence")
        private Optional<Object> codeIntelligence = Optional.of(/* serde(default) */);
        @JsonProperty("llm_usage")
        private Optional<List<LlmUsage>> llmUsage = Optional.of(/* serde(default) */);
