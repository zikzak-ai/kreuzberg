...
// alef:hash:df6ecedf00f04192e02e8ee593a2d8f2ed75aae7953e1d830fbab1a8c01edf76
...
public record HtmlOutputConfig(
    ...
    public static final class Builder {
        ...
        private Optional<String> css = Optional.of(/* serde(default) */);
        @JsonProperty("css_file")
        private Optional<java.nio.file.Path> cssFile = Optional.of(/* serde(default) */);
        private HtmlTheme theme = /* serde(default) */;
