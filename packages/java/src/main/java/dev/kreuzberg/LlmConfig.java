...
// alef:hash:03f4fdfca6bd8e3397741c38d640df88dabd5f4c993cfed7ac315a4dc65843b8
...
public record LlmConfig(
    ...
    public static final class Builder {
        ...
        private Optional<String> apiKey = Optional.of(/* serde(default) */);
        @JsonProperty("base_url")
        private Optional<String> baseUrl = Optional.of(/* serde(default) */);
        @JsonProperty("timeout_secs")
        private Optional<Long> timeoutSecs = Optional.of(/* serde(default) */);
        @JsonProperty("max_retries")
        private Optional<Integer> maxRetries = Optional.of(/* serde(default) */);
        private Optional<Double> temperature = Optional.of(/* serde(default) */);
        @JsonProperty("max_tokens")
        private Optional<Long> maxTokens = Optional.of(/* serde(default) */);
