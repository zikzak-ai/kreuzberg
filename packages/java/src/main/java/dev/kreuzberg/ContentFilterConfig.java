...
// alef:hash:5074778603c4ecd73efeb6bb58127039eab80569f2a52df7885db15d03655e3e
...
public record ContentFilterConfig(
    ...
    public static final class Builder {
        ...
        private boolean includeHeaders = /* serde(default) */;
        @JsonProperty("include_footers")
        private boolean includeFooters = /* serde(default) */;
        @JsonProperty("strip_repeating_text")
        private boolean stripRepeatingText = true;
        @JsonProperty("include_watermarks")
        private boolean includeWatermarks = /* serde(default) */;
