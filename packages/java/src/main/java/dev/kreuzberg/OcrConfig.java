...
// alef:hash:a27777b5d147adeaf954d5e211aa1188c6317d1544add67945649fdc7d8c5553
...
public record OcrConfig(
    ...
    public static final class Builder {
        ...
        private Optional<TesseractConfig> tesseractConfig = Optional.of(/* serde(default) */);
        @JsonProperty("output_format")
        private Optional<OutputFormat> outputFormat = Optional.of(/* serde(default) */);
        @JsonProperty("paddle_ocr_config")
        private Optional<Object> paddleOcrConfig = Optional.of(/* serde(default) */);
        @JsonProperty("backend_options")
        private Optional<Object> backendOptions = Optional.of(/* serde(default) */);
        @JsonProperty("element_config")
        private Optional<OcrElementConfig> elementConfig = Optional.of(/* serde(default) */);
        @JsonProperty("quality_thresholds")
        private Optional<OcrQualityThresholds> qualityThresholds = Optional.of(/* serde(default) */);
        private Optional<OcrPipelineConfig> pipeline = Optional.of(/* serde(default) */);
        @JsonProperty("auto_rotate")
        private boolean autoRotate = /* serde(default) */;
        @JsonProperty("vlm_config")
        private Optional<LlmConfig> vlmConfig = Optional.of(/* serde(default) */);
        @JsonProperty("vlm_prompt")
        private Optional<String> vlmPrompt = Optional.of(/* serde(default) */);
