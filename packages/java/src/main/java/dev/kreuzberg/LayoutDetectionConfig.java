...
// alef:hash:28e1a511c314013244f972216f1b1072ce23357e38285d31e5de04ad5ba9c309
...
public record LayoutDetectionConfig(
    ...
    public static final class Builder {
        ...
        private Optional<Float> confidenceThreshold = Optional.of(/* serde(default) */);
        @JsonProperty("apply_heuristics")
        private boolean applyHeuristics = true;
        @JsonProperty("table_model")
        private TableModel tableModel = /* serde(default) */;
