...
// alef:hash:6eefc44e3120d7f8305cdd20707f21da07b2e2fa441a87357c6144d4a97386f6
...
public record ExtractedImage(
    ...
    public static final class Builder {
        ...
        private boolean isMask = /* serde(default) */;
        private Optional<String> description = Optional.empty();
        @JsonProperty("ocr_result")
        private Optional<ExtractionResult> ocrResult = Optional.empty();
        @JsonProperty("bounding_box")
        private Optional<String> boundingBox = Optional.of(/* serde(default) */);
        @JsonProperty("source_path")
        private Optional<String> sourcePath = Optional.of(/* serde(default) */);
        @JsonProperty("image_kind")
        private Optional<ImageKind> imageKind = Optional.of(/* serde(default) */);
        @JsonProperty("kind_confidence")
        private Optional<Float> kindConfidence = Optional.of(/* serde(default) */);
        @JsonProperty("cluster_id")
        private Optional<Integer> clusterId = Optional.of(/* serde(default) */);
