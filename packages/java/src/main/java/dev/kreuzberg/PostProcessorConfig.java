...
// alef:hash:e4604a7c4f039012f9539b5f431dca960759789ea056e7f6bd5ace84097e1ccf
...
public record PostProcessorConfig(
    ...
    public static final class Builder {
        ...
        private Optional<List<String>> enabledProcessors = Optional.of(/* serde(default) */);
        @JsonProperty("disabled_processors")
        private Optional<List<String>> disabledProcessors = Optional.of(/* serde(default) */);
