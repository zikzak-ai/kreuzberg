...
// alef:hash:0e6812a09051725e0a73bc1e99d71d139281891c67b308f8218dab7f3970120b
...
public record PdfConfig(
    ...
    public static final class Builder {
        ...
        private boolean extractImages = /* serde(default) */;
        @JsonProperty("extract_tables")
        private boolean extractTables = true;
        private Optional<List<String>> passwords = Optional.of(/* serde(default) */);
        @JsonProperty("extract_metadata")
        private boolean extractMetadata = true;
        private Optional<HierarchyConfig> hierarchy = Optional.of(/* serde(default) */);
        @JsonProperty("extract_annotations")
        private boolean extractAnnotations = /* serde(default) */;
        @JsonProperty("top_margin_fraction")
        private Optional<Float> topMarginFraction = Optional.of(/* serde(default) */);
        @JsonProperty("bottom_margin_fraction")
        private Optional<Float> bottomMarginFraction = Optional.of(/* serde(default) */);
        @JsonProperty("allow_single_column_tables")
        private boolean allowSingleColumnTables = /* serde(default) */;
        @JsonProperty("ocr_inline_images")
        private boolean ocrInlineImages = /* serde(default) */;
