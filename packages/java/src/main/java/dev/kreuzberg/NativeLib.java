...
// alef:hash:0956a33c0d6a3f9ba972c82e27da075ec030d3d68c7c7964ae973fa12ed767f9
...
final class NativeLib {
    ...
    static final MethodHandle KREUZBERG_RENDER_PDF_PAGE_TO_PNG = LIB.find("kreuzberg_render_pdf_page_to_png")
        .map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG, ValueLayout.JAVA_INT, ValueLayout.ADDRESS)))
        .orElse(null);
