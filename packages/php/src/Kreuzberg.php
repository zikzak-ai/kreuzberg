...
// alef:hash:624b990ca3f661e0cdab71d518ca7ab78bbe849422fff7eccbfad617e1664350
...
string $content, string $mime_type, ExtractionConfig $config): ExtractionResult
    ...
    /**
     * Extract content from a byte array (async variant).
     *
     * Explicit async method for code that needs to differentiate between sync and async
     * extraction. Functionally equivalent to `extractBytes()`.
     *
     * @param string $content
     * @param string $mime_type
     * @param ExtractionConfig $config
...
array $items, ExtractionConfig $config): array
    ...
    /**
     * Extract content from multiple files concurrently (async variant).
     *
     * Explicit async method for code that needs to differentiate between sync and async
     * batch extraction. Functionally equivalent to `batchExtractFiles()`.
     *
     * @param array<BatchFileItem> $items
     * @param ExtractionConfig $config
     * @return array<ExtractionResult>
...
array $items, ExtractionConfig $config): array
    ...
    /**
     * Extract content from multiple byte arrays concurrently (async variant).
     *
     * Explicit async method for code that needs to differentiate between sync and async
     * batch extraction. Functionally equivalent to `batchExtractBytes()`.
     *
     * @param array<BatchBytesItem> $items
     * @param ExtractionConfig $config
     * @return array<ExtractionResult>
