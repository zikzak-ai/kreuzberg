...
extension ExtractionConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ include_document_structure: Bool, _ acceleration: AccelerationConfig?,
    _ cache_namespace: GenericIntoRustString?, _ cache_ttl_secs: UInt64?, _ email: EmailConfig?,
    _ concurrency: GenericIntoRustString?, _ max_archive_depth: UInt,
    _ tree_sitter: TreeSitterConfig?, _ structured_extraction: StructuredExtractionConfig?,
    _ cancel_token: GenericIntoRustString?
  ) {
    self.init(
