...
// alef:hash:c525375ee75c9907ed910d781c1bc40e7b86071d2b19c0d436f7aa2ad4ee69a4
...
#[derive(Clone)]
#[magnus::wrap(class = "Kreuzberg::StringGrowthValidator")]
pub struct StringGrowthValidator {
    inner: Arc<kreuzberg::extractors::security::StringGrowthValidator>,
}

unsafe impl IntoValueFromNative for StringGrowthValidator {}

impl magnus::TryConvert for StringGrowthValidator {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &StringGrowthValidator = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for StringGrowthValidator {}

impl StringGrowthValidator {}

#[derive(Clone)]
#[magnus::wrap(class = "Kreuzberg::IterationValidator")]
pub struct IterationValidator {
    inner: Arc<kreuzberg::extractors::security::IterationValidator>,
}

unsafe impl IntoValueFromNative for IterationValidator {}

impl magnus::TryConvert for IterationValidator {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &IterationValidator = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for IterationValidator {}

impl IterationValidator {}

#[derive(Clone)]
#[magnus::wrap(class = "Kreuzberg::DepthValidator")]
pub struct DepthValidator {
    inner: Arc<kreuzberg::extractors::security::DepthValidator>,
}

unsafe impl IntoValueFromNative for DepthValidator {}

impl magnus::TryConvert for DepthValidator {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &DepthValidator = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for DepthValidator {}

impl DepthValidator {}

#[derive(Clone)]
#[magnus::wrap(class = "Kreuzberg::EntityValidator")]
pub struct EntityValidator {
    inner: Arc<kreuzberg::extractors::security::EntityValidator>,
}

unsafe impl IntoValueFromNative for EntityValidator {}

impl magnus::TryConvert for EntityValidator {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &EntityValidator = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for EntityValidator {}

impl EntityValidator {}

#[derive(Clone)]
#[magnus::wrap(class = "Kreuzberg::TableValidator")]
pub struct TableValidator {
    inner: Arc<kreuzberg::extractors::security::TableValidator>,
}

unsafe impl IntoValueFromNative for TableValidator {}

impl magnus::TryConvert for TableValidator {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &TableValidator = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
unsafe impl TryConvertOwned for TableValidator {}
...
impl EmbedTextParams {
    fn new(texts: Vec<String>, preset: Option<String>, model: Option<String>, api_key: Option<String>) -> Self {
        Self {
            texts,
            preset,
            model,
...
impl LayoutDetection {
    fn new(class: LayoutClass, confidence: f32, bbox: BBox) -> Self {
        Self {
            class,
            confidence,
            bbox,
...
impl From<FormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: FormatMetadata) -> Self {
        match val {
            FormatMetadata::Pdf { _0 } => Self::Pdf(_0),
            FormatMetadata::Docx { _0 } => Self::Docx(_0.into()),
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(EmbeddingConfig::new, 6))?;
    ...
    let _class = module.define_class("StringGrowthValidator", ruby.class_object())?;

    let _class = module.define_class("IterationValidator", ruby.class_object())?;

    let _class = module.define_class("DepthValidator", ruby.class_object())?;

    let _class = module.define_class("EntityValidator", ruby.class_object())?;

    let _class = module.define_class("TableValidator", ruby.class_object())?;
    ...
    class.define_method("class", method!(LayoutRegion::class, 0))?;
    ...
    class.define_singleton_method("new", function!(EmbedTextParams::new, 4))?;
    ...
    class.define_method("class", method!(LayoutDetection::class, 0))?;
    ...
    module.define_module_function(
        ...
        function!(transform_extraction_result_to_elements, 1),
    )?;
