...
// alef:hash:b18855956a24be3c4eaef2fa055ea6abdbd94c7667e3fb523df02ba3ca93658b
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzberg::ArchiveFileEntry")]
...
unsafe impl IntoValueFromNative for ArchiveFileEntry {}

impl magnus::TryConvert for ArchiveFileEntry {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        if let Ok(r) = <&ArchiveFileEntry as magnus::TryConvert>::try_convert(val) {
            return Ok(r.clone());
        }
        let json_str: String = if let Ok(s) = <String as magnus::TryConvert>::try_convert(val) {
            s
            ...
            val.funcall::<_, _, String>("to_json", ()).map_err(|e| {
                magnus::Error::new(
                    unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                    format!("no implicit conversion into ArchiveFileEntry: {}", e),
                )
            })?
        };
        serde_json::from_str::<ArchiveFileEntry>(&json_str).map_err(|e| {
            magnus::Error::new(
                unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                format!("failed to deserialize ArchiveFileEntry: {}", e),
            )
        })
    }
}
unsafe impl TryConvertOwned for ArchiveFileEntry {}

impl Default for ArchiveFileEntry {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzberg::StructuredMetadata")]
...
unsafe impl IntoValueFromNative for StructuredMetadata {}

impl magnus::TryConvert for StructuredMetadata {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        if let Ok(r) = <&StructuredMetadata as magnus::TryConvert>::try_convert(val) {
            return Ok(r.clone());
        }
        let json_str: String = if let Ok(s) = <String as magnus::TryConvert>::try_convert(val) {
            s
            ...
            val.funcall::<_, _, String>("to_json", ()).map_err(|e| {
                magnus::Error::new(
                    unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                    format!("no implicit conversion into StructuredMetadata: {}", e),
                )
            })?
        };
        serde_json::from_str::<StructuredMetadata>(&json_str).map_err(|e| {
            magnus::Error::new(
                unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                format!("failed to deserialize StructuredMetadata: {}", e),
            )
        })
    }
}
unsafe impl TryConvertOwned for StructuredMetadata {}
...
impl StructuredMetadata {
    fn new(data_format: String, field_count: usize, custom_fields: Option<HashMap<String, String>>) -> Self {
        Self {
            data_format,
            field_count,
            custom_fields,
    ...
    fn custom_fields(&self) -> Option<HashMap<String, String>> {
...
pub enum FormatMetadata {
    ...
    Ocr { _0: OcrMetadata },
    Csv { _0: CsvMetadata },
    Structured { _0: StructuredMetadata },
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<ArchiveFileEntry> for kreuzberg::ArchiveFileEntry {
    fn from(val: ArchiveFileEntry) -> Self {
        Self {
            path: val.path,
            size: val.size,
            is_dir: val.is_dir,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ArchiveFileEntry> for ArchiveFileEntry {
    fn from(val: kreuzberg::ArchiveFileEntry) -> Self {
        Self {
            path: val.path,
            size: val.size,
            is_dir: val.is_dir,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<StructuredMetadata> for kreuzberg::StructuredMetadata {
    fn from(val: StructuredMetadata) -> Self {
        Self {
            data_format: val.data_format,
            field_count: val.field_count,
            custom_fields: val.custom_fields.map(|m| {
                m.into_iter()
                    .map(|(k, v)| (k.into(), serde_json::from_str(&v).unwrap_or_default()))
                    .collect()
            }),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::StructuredMetadata> for StructuredMetadata {
    fn from(val: kreuzberg::StructuredMetadata) -> Self {
        Self {
            data_format: val.data_format,
            field_count: val.field_count,
            custom_fields: val
...
impl From<kreuzberg::BibtexMetadata> for BibtexMetadata {
    fn from(val: kreuzberg::BibtexMetadata) -> Self {
        Self {
            ...
            year_range: val.year_range.map(Into::into),
            entry_types: val.entry_types.map(|m| m.into_iter().collect()),
            entries: val.entries.as_ref().map(|v| v.iter().map(|i| i.to_string()).collect()),
        }
    }
}
...
impl From<FormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: FormatMetadata) -> Self {
        match val {
            ...
            FormatMetadata::Structured { _0 } => Self::Structured(_0.into()),
...
impl From<kreuzberg::FormatMetadata> for FormatMetadata {
    fn from(val: kreuzberg::FormatMetadata) -> Self {
        match val {
            ...
            kreuzberg::FormatMetadata::Structured(_0) => Self::Structured { _0: _0.into() },
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("extraction_method", method!(Metadata::extraction_method, 0))?;
    ...
    class.define_singleton_method("new", function!(ExcelMetadata::new, 3))?;
    ...
    class.define_method("custom_properties", method!(ExcelMetadata::custom_properties, 0))?;

    let class = module.define_class("EmailMetadata", ruby.class_object())?;
    class.define_singleton_method("new", function!(EmailMetadata::new, 8))?;
    ...
    class.define_method("extra_headers", method!(EmailMetadata::extra_headers, 0))?;

    let class = module.define_class("ArchiveFileEntry", ruby.class_object())?;
    class.define_singleton_method("new", function!(ArchiveFileEntry::new, 3))?;
    class.define_method("path", method!(ArchiveFileEntry::path, 0))?;
    class.define_method("size", method!(ArchiveFileEntry::size, 0))?;
    class.define_method("is_dir", method!(ArchiveFileEntry::is_dir, 0))?;
    ...
    class.define_method("entries", method!(ArchiveMetadata::entries, 0))?;
    ...
    class.define_singleton_method("new", function!(PptxMetadata::new, 5))?;
    ...
    class.define_method("custom_properties", method!(PptxMetadata::custom_properties, 0))?;
    ...
    let class = module.define_class("StructuredMetadata", ruby.class_object())?;
    class.define_singleton_method("new", function!(StructuredMetadata::new, 3))?;
    class.define_method("data_format", method!(StructuredMetadata::data_format, 0))?;
    class.define_method("field_count", method!(StructuredMetadata::field_count, 0))?;
    class.define_method("custom_fields", method!(StructuredMetadata::custom_fields, 0))?;
    ...
    class.define_singleton_method("new", function!(BibtexMetadata::new, 6))?;
    ...
    class.define_method("entries", method!(BibtexMetadata::entries, 0))?;
