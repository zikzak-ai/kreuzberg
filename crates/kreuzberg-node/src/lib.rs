...
// alef:hash:e9b5d1f325a7c0e12851b552e96e2604f1f76f94dae6df066d078b71abe06b9a
...
pub struct JsOcrConfig {
    ...
    pub tessdata_bytes: Option<HashMap<String, napi::bindgen_prelude::Buffer>>,
}
        ...
        match result {
            ...
            Ok(val) => {
                ...
                match s.as_str() {
                    ...
                    _ => serde_json::from_str::<_>(&s).map_err(|_| {
                        kreuzberg::KreuzbergError::Other(format!(
                            "Failed to parse return value for method 'render'",
                            self.cached_name
                        ))
                    }),
                }
...
impl From<JsOcrConfig> for kreuzberg::OcrConfig {
    fn from(val: JsOcrConfig) -> Self {
        ...
        __result.acceleration = val.acceleration.map(Into::into);
        __result.tessdata_bytes = val.tessdata_bytes.map(|m| m.into_iter().collect());
        __result
    }
}
