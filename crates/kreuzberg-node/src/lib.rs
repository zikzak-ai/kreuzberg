...
// alef:hash:61ca0056fcaeac519ebd588ab3879f6362c4184ec4abb0226b5e28294183aa14
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object)]
pub struct JsArchiveArchiveMetadata {
    pub format: String,
    #[napi(js_name = "fileList")]
    pub file_list: Vec<JsArchiveEntry>,
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object)]
pub struct JsArchiveArchiveEntry {
    pub path: String,
    pub size: i64,
    #[napi(js_name = "isDir")]
    pub is_dir: bool,
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object)]
pub struct JsOcrTesseractConfig {
    pub language: Option<String>,
    pub psm: Option<u8>,
    #[napi(js_name = "outputFormat")]
    pub output_format: Option<String>,
    ...
    pub table_min_confidence: Option<f64>,
    #[napi(js_name = "tableColumnThreshold")]
    pub table_column_threshold: Option<u32>,
    #[napi(js_name = "tableRowThresholdRatio")]
    pub table_row_threshold_ratio: Option<f64>,
    #[napi(js_name = "useCache")]
    pub use_cache: Option<bool>,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::extraction::archive::ArchiveMetadata> for JsArchiveArchiveMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::extraction::archive::ArchiveEntry> for JsArchiveArchiveEntry {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ocr::TesseractConfig> for JsOcrTesseractConfig {
