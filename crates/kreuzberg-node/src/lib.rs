...
// alef:hash:2162691f7ba8b21fbd51dd3440c98b12f8b9c80214ce9544ef65476b0117eb13
...
pub struct JsArchiveMetadata {
    ...
    pub entries: Option<Vec<JsArchiveFileEntry>>,
...
impl JsFormatMetadata {
    ...
    #[napi(getter)]
    pub fn structured(&self) -> Option<JsStructuredMetadata> {
        if self.format_type_tag != "structured" {
            return None;
        }
        self._0
            .as_ref()
            .and_then(|s| serde_json::from_str::<JsStructuredMetadata>(s).ok())
    }
...
impl From<JsMetadata> for kreuzberg::Metadata {
    fn from(val: JsMetadata) -> Self {
        ...
        __result.extraction_method = val.extraction_method;
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsArchiveFileEntry> for kreuzberg::ArchiveFileEntry {
    fn from(val: JsArchiveFileEntry) -> Self {
        let mut __result = kreuzberg::ArchiveFileEntry::default();
        if let Some(__v) = val.path {
            __result.path = __v;
        }
        if let Some(__v) = val.size {
            __result.size = __v as u64;
        }
        if let Some(__v) = val.is_dir {
            __result.is_dir = __v;
        }
        __result
    }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ArchiveFileEntry> for JsArchiveFileEntry {
    fn from(val: kreuzberg::ArchiveFileEntry) -> Self {
        Self {
            path: Some(val.path),
            size: Some(val.size as i64),
            is_dir: Some(val.is_dir),
        }
    }
}
...
impl From<JsArchiveMetadata> for kreuzberg::ArchiveMetadata {
    fn from(val: JsArchiveMetadata) -> Self {
        ...
        if let Some(__v) = val.entries {
            __result.entries = __v.into_iter().map(Into::into).collect();
        }
...
impl From<kreuzberg::ArchiveMetadata> for JsArchiveMetadata {
    fn from(val: kreuzberg::ArchiveMetadata) -> Self {
        Self {
            ...
            entries: Some(val.entries.into_iter().map(Into::into).collect()),
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsStructuredMetadata> for kreuzberg::StructuredMetadata {
    fn from(val: JsStructuredMetadata) -> Self {
        let mut __result = kreuzberg::StructuredMetadata::default();
        if let Some(__v) = val.data_format {
            __result.data_format = __v;
        }
        if let Some(__v) = val.field_count {
            __result.field_count = __v as usize;
        }
        __result.custom_fields = val.custom_fields.map(|m| {
            m.into_iter()
                .map(|(k, v)| (k.into(), serde_json::from_str(&v).unwrap_or_default()))
                .collect()
        });
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::StructuredMetadata> for JsStructuredMetadata {
    fn from(val: kreuzberg::StructuredMetadata) -> Self {
        Self {
            data_format: Some(val.data_format),
    ...
    fn from(val: JsFormatMetadata) -> Self {
        match val.format_type_tag.as_str() {
            ...
            "structured" => Self::Structured(
                val._0
                    .and_then(|s| serde_json::from_str::<kreuzberg::StructuredMetadata>(&s).ok())
                    .unwrap_or_default(),
            ),
            "bibtex" => Self::Bibtex(
                val._0
...
impl From<kreuzberg::FormatMetadata> for JsFormatMetadata {
    fn from(val: kreuzberg::FormatMetadata) -> Self {
        match val {
            ...
            kreuzberg::FormatMetadata::Structured(_0) => Self {
                format_type_tag: "structured".to_string(),
                _0: serde_json::to_string(&_0).ok(),
            },
