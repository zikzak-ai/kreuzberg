...
// alef:hash:d6bbda4f4c51ef79099b9b430b73b9973daf05ae0046bf3b9d11c65a1fe4b42c
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\ArchiveArchiveMetadata")]
...
impl ArchiveArchiveMetadata {
    ...
    #[php(getter)]
    pub fn get_file_list(&self) -> Vec<ArchiveEntry> {
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\ArchiveArchiveEntry")]
...
impl ArchiveArchiveEntry {
    pub fn __construct(path: String, size: i64, is_dir: bool) -> Self {
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\OcrTesseractConfig")]
#[allow(clippy::similar_names)]
