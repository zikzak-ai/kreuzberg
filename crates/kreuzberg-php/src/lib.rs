...
// alef:hash:68b43c5abff4b6bea4e559d583d1f04c355e16d602350cd1ec475d63320e28f8
...
impl EmailConfig {
    ...
    #[php(constructor)]
    pub fn new(msgFallbackCodepage: Option<u32>) -> Self {
        Self {
...
impl ExtractionConfig {
    ...
    pub fn new(
        ...
        contentFilter: Option<ContentFilterConfig>,
        images: Option<ImageExtractionConfig>,
        pdfOptions: Option<PdfConfig>,
        tokenReduction: Option<TokenReductionOptions>,
        languageDetection: Option<LanguageDetectionConfig>,
        pages: Option<PageConfig>,
        keywords: Option<KeywordConfig>,
        postprocessor: Option<PostProcessorConfig>,
        htmlOptions: Option<String>,
        htmlOutput: Option<HtmlOutputConfig>,
        extractionTimeoutSecs: Option<i64>,
        maxConcurrentExtractions: Option<i64>,
        resultFormat: String,
        securityLimits: Option<SecurityLimits>,
        outputFormat: String,
        ...
        maxArchiveDepth: i64,
        treeSitter: Option<TreeSitterConfig>,
        structuredExtraction: Option<StructuredExtractionConfig>,
...
impl BatchBytesItem {
    ...
    #[php(constructor)]
    pub fn new(content: Vec<u8>, mimeType: String, config: Option<FileExtractionConfig>) -> Self {
        Self {
            content,
            mime_type: mimeType,
            config,
...
impl OcrPipelineStage {
    ...
    pub fn new(
        ...
        tesseractConfig: Option<TesseractConfig>,
        paddleOcrConfig: Option<String>,
        vlmConfig: Option<LlmConfig>,
    ) -> Self {
        Self {
            backend,
            priority,
...
impl OcrPipelineConfig {
    ...
    #[php(constructor)]
    pub fn new(stages: Vec<OcrPipelineStage>, qualityThresholds: Option<OcrQualityThresholds>) -> Self {
        Self {
            stages,
            quality_thresholds: qualityThresholds.unwrap_or_default(),
        }
    }
...
impl OcrConfig {
    ...
    pub fn new(
        ...
        outputFormat: Option<String>,
        paddleOcrConfig: Option<String>,
        elementConfig: Option<OcrElementConfig>,
        qualityThresholds: Option<OcrQualityThresholds>,
...
impl TokenReductionConfig {
    ...
    pub fn new(
        ...
        enableParallel: bool,
        useSimd: bool,
        customStopwords: Option<HashMap<String, Vec<String>>>,
...
impl TextAnnotation {
    ...
    #[php(constructor)]
    pub fn new(start: u32, end: u32, kind: Option<AnnotationKind>) -> Self {
        Self {
            start,
            end,
...
impl ExtractionResult {
    ...
    pub fn new(
        ...
        djotContent: Option<DjotContent>,
...
impl ArchiveEntry {
    ...
    #[php(constructor)]
    pub fn new(path: String, mimeType: String, result: Option<ExtractionResult>) -> Self {
        Self {
            path,
            mime_type: mimeType,
...
impl ChunkMetadata {
    ...
    pub fn new(
        ...
        lastPage: Option<i64>,
        headingContext: Option<HeadingContext>,
    ) -> Self {
        Self {
...
impl ExtractedImage {
    ...
    pub fn new(
        ...
        isMask: bool,
        description: Option<String>,
        ocrResult: Option<ExtractionResult>,
...
impl Element {
    ...
    #[php(constructor)]
    pub fn new(elementId: String, elementType: String, text: String, metadata: Option<ElementMetadata>) -> Self {
        Self {
...
impl ExcelWorkbook {
    ...
    #[php(constructor)]
    pub fn new(sheets: Vec<ExcelSheet>, metadata: Option<HashMap<String, String>>) -> Self {
        Self {
            sheets,
            metadata: metadata.unwrap_or_default(),
        }
...
impl PptxExtractionResult {
    ...
    pub fn new(
        content: String,
        metadata: Option<PptxMetadata>,
        slideCount: i64,
        imageCount: i64,
        tableCount: i64,
        images: Vec<ExtractedImage>,
        pageStructure: Option<PageStructure>,
        pageContents: Option<Vec<PageContent>>,
        document: Option<DocumentStructure>,
        hyperlinks: Vec<String>,
        officeMetadata: Option<HashMap<String, String>>,
    ) -> Self {
        Self {
            content,
            metadata: metadata.unwrap_or_default(),
            ...
            document,
            hyperlinks,
            office_metadata: officeMetadata.unwrap_or_default(),
        }
    }
...
impl OcrTable {
    ...
    pub fn new(
        ...
        markdown: String,
        pageNumber: i64,
        boundingBox: Option<OcrTableBoundingBox>,
    ) -> Self {
        Self {
            cells,
            markdown,
...
impl Metadata {
    ...
    pub fn new(
        ...
        imagePreprocessing: Option<ImagePreprocessingMetadata>,
...
impl ExcelMetadata {
    ...
    #[php(constructor)]
    pub fn new(sheetCount: Option<i64>, sheetNames: Option<Vec<String>>) -> Self {
        Self {
...
impl HtmlMetadata {
    ...
    pub fn new(
        ...
        openGraph: Option<HashMap<String, String>>,
        twitterCard: Option<HashMap<String, String>>,
        metaTags: Option<HashMap<String, String>>,
...
impl DocxMetadata {
    ...
    #[php(constructor)]
    pub fn new(
        coreProperties: Option<CoreProperties>,
        appProperties: Option<DocxAppProperties>,
        customProperties: Option<HashMap<String, String>>,
    ) -> Self {
        Self {
...
impl BibtexMetadata {
    ...
    pub fn new(
        entryCount: i64,
        citationKeys: Vec<String>,
        authors: Vec<String>,
        yearRange: Option<YearRange>,
        entryTypes: Option<HashMap<String, i64>>,
    ) -> Self {
        Self {
...
impl JatsMetadata {
    ...
    pub fn new(
        ...
        historyDates: Option<HashMap<String, String>>,
        contributorRoles: Vec<ContributorRole>,
    ) -> Self {
        Self {
            copyright,
            license,
...
impl OcrElement {
    ...
    pub fn new(
        ...
        backendMetadata: Option<HashMap<String, String>>,
    ) -> Self {
        Self {
            text,
...
impl StructuredExtractionResponse {
    ...
    #[php(constructor)]
    pub fn new(structuredOutput: Option<String>, content: String, mimeType: String) -> Self {
        Self {
...
impl KeywordConfig {
    ...
    pub fn new(
        ...
        ngramRange: Vec<i64>,
        language: Option<String>,
        yakeParams: Option<YakeParams>,
        rakeParams: Option<RakeParams>,
    ) -> Self {
        Self {
            algorithm,
...
impl RecognizedTable {
    ...
    #[php(constructor)]
    pub fn new(detectionBbox: Option<BBox>, cells: Vec<Vec<String>>, markdown: String) -> Self {
        Self {
            detection_bbox: detectionBbox.unwrap_or_default(),
            cells,
            markdown,
        }
    }
...
impl LayoutDetection {
    ...
    #[php(constructor)]
    pub fn new(className: String, confidence: f32, bbox: Option<BBox>) -> Self {
        Self {
            class_name: className,
            confidence,
