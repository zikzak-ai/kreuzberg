...
// alef:hash:58449872ba4b5b2bbe06718fddaa9c68ee0303ac48023cbe96faf03babd48f8a
...
impl EmailMetadata {
    ...
    #[php(getter)]
    pub fn get_extra_headers(&self) -> Option<HashMap<String, String>> {
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Kreuzberg\\ArchiveFileEntry")]
#[serde(default, rename_all = "camelCase")]
...
impl ArchiveMetadata {
    ...
    #[php(getter)]
    pub fn get_entries(&self) -> Vec<ArchiveFileEntry> {
        self.entries.clone()
    }
}
...
impl StructuredMetadata {
    ...
    #[php(getter)]
    pub fn get_custom_fields(&self) -> Option<HashMap<String, String>> {
...
impl FormatMetadata {
    ...
    #[php(getter)]
    pub fn get_structured(&self) -> Option<StructuredMetadata> {
...
impl From<FormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: FormatMetadata) -> Self {
        match val.format_type_tag.as_str() {
            ...
            "structured" => kreuzberg::FormatMetadata::Structured(val.structured.map(Into::into).unwrap_or_default()),
