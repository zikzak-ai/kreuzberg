...
// alef:hash:f4ea3368a2d59ae974a9211da5891dccbbf4e97171a56ae140dc8dded7abda3e
    ...
    pub fn needs_image_processing(&self) -> bool {
        #[allow(clippy::needless_update)]
            let core_self = kreuzberg::ExtractionConfig {
                ...
                force_ocr_pages: self.force_ocr_pages.clone().map(|v| v.into_iter().map(|x| x as usize).collect()),
...
impl StructuredDataResult {
    pub fn __construct(content: String, format: String, metadata: HashMap<String, String>, text_fields: Vec<String>) -> Self {
...
#[php_impl]
impl ChunkResponse {
    pub fn __construct(chunks: Vec<String>, chunk_count: i64, config: String, input_size_bytes: i64, chunker_type: String) -> Self {
...
impl RakeParams {
    pub fn __construct(
        ...
        max_words_per_phrase: Option<i64>
    ) -> Self {
        Self {
...
impl TessdataManager {
        ...
        let result = self.inner.ensure_all_languages().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result as i64)
    }
}
...
impl KreuzbergApi {
        ...
        let result = kreuzberg::blake3_hash_file(std::path::Path::new(&path)).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_port(port).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_host(&host).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::core::config_validation::validate_cors_origin(&origin).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::core::config_validation::validate_upload_size(size as usize).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_binarization_method(&method).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_token_reduction_level(&level).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_ocr_backend(&backend).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_language_code(&code).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_tesseract_psm(psm).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_tesseract_oem(oem).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_output_format(&format).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_confidence(confidence).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::core::validate_dpi(dpi).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::validate_chunking_params(max_chars as usize, max_overlap as usize).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::core::config_validation::validate_llm_config_model(&model).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
         ...
         * ```
         */
        pub fn extract_bytes_async(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> PhpResult<ExtractionResult> {
        let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::extract_bytes(&content, &mime_type, &config_core).await.map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into())
        })
    }
         ...
         * ```
         */
        pub fn extract_file_async(path: String, mime_type: Option<String>, config: &ExtractionConfig) -> PhpResult<ExtractionResult> {
        let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::extract_file(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core).await.map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into())
        })
    }
         ...
         * ```
         */
        pub fn extract_file_sync(path: String, mime_type: Option<String>, config: &ExtractionConfig) -> PhpResult<ExtractionResult> {
        let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
         ...
         * ```
         */
        pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> PhpResult<ExtractionResult> {
        let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::extract_bytes_sync(&content, &mime_type, &config_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
        ...
        let items_core: Vec<_> = items.into_iter().map(|s| serde_json::from_str::<_>(&s).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))).collect::<Result<Vec<_>, _>>()?;
    let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::batch_extract_file_sync(items_core, &config_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
    ...
    let config_json = serde_json::to_string(&config)
        ...
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::batch_extract_bytes_sync(items_core, &config_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
    ...
    let config_json = serde_json::to_string(&config)
        ...
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::batch_extract_file(items_core, &config_core).await.map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into_iter().map(Into::into).collect())
        })
    }
         ...
         * ```
         */
        pub fn batch_extract_bytes_async(items: Vec<String>, config: &ExtractionConfig) -> PhpResult<Vec<ExtractionResult>> {
        let items_core: Vec<_> = items.into_iter().map(|s| serde_json::from_str::<_>(&s).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))).collect::<Result<Vec<_>, _>>()?;
    let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::batch_extract_bytes(items_core, &config_core).await.map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into_iter().map(Into::into).collect())
        })
    }
        ...
        let result = kreuzberg::validate_mime_type(&mime_type).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::detect_or_validate(path.as_deref(), mime_type.as_deref()).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::detect_mime_type_from_bytes(&content).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::get_extensions_for_mime(&mime_type).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::core::pipeline::clear_processor_cache().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    kreuzberg::extraction::transform::transform_extraction_result_to_elements(&result_core).into_iter().map(Into::into).collect()
    }

        /**
         * Extract email content from either .eml or .msg format
         */
        pub fn extract_email_content(data: Vec<u8>, mime_type: String, fallback_codepage: Option<u32>) -> PhpResult<EmailExtractionResult> {
        let result = kreuzberg::extract_email_content(&data, &mime_type, fallback_codepage).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
        ...
        let result = kreuzberg::djot_to_html(&djot_source).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::extractors::register_default_extractors().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::unregister_extractor(&name).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::list_extractors().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::clear_extractors().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::unregister_ocr_backend(&name).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::clear_ocr_backends().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::unregister_renderer(&name).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::list_renderers().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::clear_renderers().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result = kreuzberg::plugins::clear_validators().map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
         ...
         * ```
         */
        pub fn reduce_tokens(text: String, config: &TokenReductionConfig, language_hint: Option<String>) -> PhpResult<String> {
        let config_json = serde_json::to_string(&config)
            .map_err(|e| format!("{e}"))?;
        let config_core: kreuzberg::TokenReductionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::reduce_tokens(&text, &config_core, language_hint.as_deref()).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        StringBufferPool { inner: Arc::new(kreuzberg::utils::pool::create_string_buffer_pool(pool_size as usize, buffer_capacity as usize)) }
    }
        ...
        ByteBufferPool { inner: Arc::new(kreuzberg::utils::pool::create_byte_buffer_pool(pool_size as usize, buffer_capacity as usize)) }
    }
        ...
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::api::serve_default().await.map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result)
        })
    }
        ...
        let model_type_core: kreuzberg::EmbeddingModelType = serde_json::from_str(&model_type_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::warm_model(&model_type_core, cache_dir.map(std::path::PathBuf::from)).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let model_type_core: kreuzberg::EmbeddingModelType = serde_json::from_str(&model_type_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::download_model(&model_type_core, cache_dir.map(std::path::PathBuf::from)).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let config_core: kreuzberg::LanguageDetectionConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::language_detection::detect_languages(&text, &config_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let config_core: kreuzberg::KeywordConfig = serde_json::from_str(&config_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::extract_keywords(&text, &config_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
         ...
         * ```
         */
        pub fn render_pdf_page_to_png(pdf_bytes: Vec<u8>, page_index: i64, dpi: Option<i32>, password: Option<String>) -> PhpResult<Vec<u8>> {
        let result = kreuzberg::pdf::rendering::render_pdf_page_to_png(&pdf_bytes, page_index as usize, dpi, password.as_deref()).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.to_vec())
    }

        pub fn extract_text_from_pdf(pdf_bytes: Vec<u8>) -> PhpResult<String> {
        let result = kreuzberg::extract_text_from_pdf(&pdf_bytes).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result_core: kreuzberg::ExtractionResult = serde_json::from_str(&result_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::serialize_to_toon(&result_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
        ...
        let result_core: kreuzberg::ExtractionResult = serde_json::from_str(&result_json)
            .map_err(|e| format!("{e}"))?;
    let result = kreuzberg::serialize_to_json(&result_core).map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
}
...
impl kreuzberg::plugins::OcrBackend for PhpOcrBackendBridge {
    ...
    async fn process_image_file(&self, path: &std::path::Path, config: &kreuzberg::OcrConfig) -> std::result::Result<kreuzberg::ExtractionResult, kreuzberg::KreuzbergError> {
        ...
        // The block_on executes within the async runtime.
        WORKER_RUNTIME.block_on(async {
            match unsafe { (*inner_obj).try_call_method("process_image_file", [ext_php_rs::types::Zval::try_from(path.to_string_lossy().to_string()).unwrap_or_default(), ext_php_rs::types::Zval::try_from(serde_json::to_string(&config).unwrap_or_default()).unwrap_or_default()].iter().map(|z| z as &dyn ext_php_rs::convert::IntoZvalDyn).collect()) } {
                Ok(val) => {
                    let json_str = val.string().unwrap_or_default();
                    serde_json::from_str(&json_str).map_err(|e| kreuzberg::KreuzbergError::Other(format!("Deserialize error: {}", e)))
                }
    ...
    async fn process_document(&self, _path: &std::path::Path, _config: &kreuzberg::OcrConfig) -> std::result::Result<kreuzberg::ExtractionResult, kreuzberg::KreuzbergError> {
        ...
        // The block_on executes within the async runtime.
        WORKER_RUNTIME.block_on(async {
            match unsafe { (*inner_obj).try_call_method("process_document", [ext_php_rs::types::Zval::try_from(_path.to_string_lossy().to_string()).unwrap_or_default(), ext_php_rs::types::Zval::try_from(serde_json::to_string(&_config).unwrap_or_default()).unwrap_or_default()].iter().map(|z| z as &dyn ext_php_rs::convert::IntoZvalDyn).collect()) } {
                Ok(val) => {
                    let json_str = val.string().unwrap_or_default();
                    serde_json::from_str(&json_str).map_err(|e| kreuzberg::KreuzbergError::Other(format!("Deserialize error: {}", e)))
                }
...
pub fn register_ocr_backend(backend: &mut ext_php_rs::types::ZendObject) -> ext_php_rs::prelude::PhpResult<()> {
    if backend.try_call_method("process_image", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "process_image")
        ));
    }
    if backend.try_call_method("supports_language", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "supports_language")
        ));
    }
    if backend.try_call_method("backend_type", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "backend_type")
        ));
    }
...
impl kreuzberg::plugins::PostProcessor for PhpPostProcessorBridge {
    ...
    fn should_process(&self, _result: &kreuzberg::ExtractionResult, _config: &kreuzberg::ExtractionConfig) -> bool {
        // SAFETY: PHP objects are single-threaded; method calls are safe within a request.
        let result = unsafe { (*self.inner).try_call_method("should_process", [ext_php_rs::types::Zval::try_from(serde_json::to_string(&_result).unwrap_or_default()).unwrap_or_default(), ext_php_rs::types::Zval::try_from(serde_json::to_string(&_config).unwrap_or_default()).unwrap_or_default()].iter().map(|z| z as &dyn ext_php_rs::convert::IntoZvalDyn).collect()) };
        match result {
            Ok(val) => {
                let json_str = val.string().unwrap_or_default();
                serde_json::from_str(&json_str).unwrap_or_default()
    ...
    fn estimated_duration_ms(&self, _result: &kreuzberg::ExtractionResult) -> u64 {
        // SAFETY: PHP objects are single-threaded; method calls are safe within a request.
        let result = unsafe { (*self.inner).try_call_method("estimated_duration_ms", [ext_php_rs::types::Zval::try_from(serde_json::to_string(&_result).unwrap_or_default()).unwrap_or_default()].iter().map(|z| z as &dyn ext_php_rs::convert::IntoZvalDyn).collect()) };
        match result {
            Ok(val) => {
                let json_str = val.string().unwrap_or_default();
                serde_json::from_str(&json_str).unwrap_or_default()
...
pub fn register_post_processor(backend: &mut ext_php_rs::types::ZendObject) -> ext_php_rs::prelude::PhpResult<()> {
    if backend.try_call_method("process", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "process")
        ));
    }
    if backend.try_call_method("processing_stage", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "processing_stage")
        ));
    }
    ...
    let mut registry = registry.write();
    registry.register(arc, 50).map_err(|e| ext_php_rs::exception::PhpException::default(
        format!("Failed to register backend: {}", e)
    ))?;
    Ok(())
}
...
impl kreuzberg::plugins::Validator for PhpValidatorBridge {
    ...
    fn should_validate(&self, _result: &kreuzberg::ExtractionResult, _config: &kreuzberg::ExtractionConfig) -> bool {
        // SAFETY: PHP objects are single-threaded; method calls are safe within a request.
        let result = unsafe { (*self.inner).try_call_method("should_validate", [ext_php_rs::types::Zval::try_from(serde_json::to_string(&_result).unwrap_or_default()).unwrap_or_default(), ext_php_rs::types::Zval::try_from(serde_json::to_string(&_config).unwrap_or_default()).unwrap_or_default()].iter().map(|z| z as &dyn ext_php_rs::convert::IntoZvalDyn).collect()) };
        match result {
            Ok(val) => {
                let json_str = val.string().unwrap_or_default();
                serde_json::from_str(&json_str).unwrap_or_default()
...
pub fn register_validator(backend: &mut ext_php_rs::types::ZendObject) -> ext_php_rs::prelude::PhpResult<()> {
    if backend.try_call_method("validate", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "validate")
        ));
    }
...
pub fn register_embedding_backend(backend: &mut ext_php_rs::types::ZendObject) -> ext_php_rs::prelude::PhpResult<()> {
    if backend.try_call_method("dimensions", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "dimensions")
        ));
    }
    if backend.try_call_method("embed", vec![]).is_err() {
        return Err(ext_php_rs::exception::PhpException::default(
            format!("Backend missing required method: {}", "embed")
        ));
    }
...
impl From<kreuzberg::AccelerationConfig> for AccelerationConfig {
    fn from(val: kreuzberg::AccelerationConfig) -> Self {
        Self {
            provider: serde_json::to_value(val.provider).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::ExtractionConfig> for ExtractionConfig {
    fn from(val: kreuzberg::ExtractionConfig) -> Self {
        Self {
            ...
            force_ocr_pages: val.force_ocr_pages.as_ref().map(|v| v.iter().map(|&x| x as i64).collect()),
...
impl From<kreuzberg::HtmlOutputConfig> for HtmlOutputConfig {
    fn from(val: kreuzberg::HtmlOutputConfig) -> Self {
        Self {
            ...
            theme: serde_json::to_value(val.theme).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::LayoutDetectionConfig> for LayoutDetectionConfig {
    fn from(val: kreuzberg::LayoutDetectionConfig) -> Self {
        Self {
            ...
            table_model: serde_json::to_value(val.table_model).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            acceleration: val.acceleration.map(Into::into),
        }
    }
}
...
impl From<kreuzberg::PdfConfig> for PdfConfig {
    fn from(val: kreuzberg::PdfConfig) -> Self {
        Self {
            backend: serde_json::to_value(val.backend).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            extract_images: val.extract_images,
...
impl From<kreuzberg::ChunkingConfig> for ChunkingConfig {
    fn from(val: kreuzberg::ChunkingConfig) -> Self {
        Self {
            ...
            trim: val.trim,
            chunker_type: serde_json::to_value(val.chunker_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::TreeSitterProcessConfig> for TreeSitterProcessConfig {
    fn from(val: kreuzberg::TreeSitterProcessConfig) -> Self {
        Self {
            ...
            content_mode: serde_json::to_value(val.content_mode).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
        }
    }
}
...
impl From<kreuzberg::TokenReductionConfig> for TokenReductionConfig {
    fn from(val: kreuzberg::TokenReductionConfig) -> Self {
        Self {
            level: serde_json::to_value(val.level).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::PdfAnnotation> for PdfAnnotation {
    fn from(val: kreuzberg::PdfAnnotation) -> Self {
        Self {
            annotation_type: serde_json::to_value(val.annotation_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            content: val.content,
...
impl From<kreuzberg::FormattedBlock> for FormattedBlock {
    fn from(val: kreuzberg::FormattedBlock) -> Self {
        Self {
            block_type: serde_json::to_value(val.block_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::InlineElement> for InlineElement {
    fn from(val: kreuzberg::InlineElement) -> Self {
        Self {
            element_type: serde_json::to_value(val.element_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            content: val.content,
            attributes: val.attributes.as_ref().map(|v| format!("{v:?}")),
...
impl From<kreuzberg::DocumentRelationship> for DocumentRelationship {
    fn from(val: kreuzberg::DocumentRelationship) -> Self {
        Self {
            source: val.source.0,
            target: val.target.0,
            kind: serde_json::to_value(val.kind).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
        }
    }
}
...
impl From<kreuzberg::DocumentNode> for DocumentNode {
    fn from(val: kreuzberg::DocumentNode) -> Self {
        Self {
            ...
            content_layer: serde_json::to_value(val.content_layer).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            page: val.page,
...
impl From<kreuzberg::ExtractionResult> for ExtractionResult {
    fn from(val: kreuzberg::ExtractionResult) -> Self {
        Self {
            ...
            metadata: val.metadata.into(),
            extraction_method: val.extraction_method.as_ref().map(|v| serde_json::to_value(v).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default()),
            tables: val.tables.iter().map(|i| format!("{:?}", i)).collect(),
...
impl From<kreuzberg::Chunk> for Chunk {
    fn from(val: kreuzberg::Chunk) -> Self {
        Self {
            content: val.content,
            chunk_type: serde_json::to_value(val.chunk_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::LinkMetadata> for LinkMetadata {
    fn from(val: kreuzberg::LinkMetadata) -> Self {
        Self {
            ...
            text: val.text,
            title: val.title,
            link_type: serde_json::to_value(val.link_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            rel: val.rel,
            attributes: val.attributes.iter().map(|i| format!("{:?}", i)).collect(),
        }
    }
...
impl From<kreuzberg::ImageMetadataType> for ImageMetadataType {
    fn from(val: kreuzberg::ImageMetadataType) -> Self {
        Self {
            ...
            title: val.title,
            dimensions: val.dimensions.map(|t| { let arr: Vec<_> = [t.0, t.1].into_iter().map(|v| v as _).collect(); arr }),
            image_type: serde_json::to_value(val.image_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            attributes: val.attributes.iter().map(|i| format!("{:?}", i)).collect(),
        }
    }
}
...
impl From<kreuzberg::StructuredData> for StructuredData {
    fn from(val: kreuzberg::StructuredData) -> Self {
        Self {
            data_type: serde_json::to_value(val.data_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::HtmlMetadata> for HtmlMetadata {
    fn from(val: kreuzberg::HtmlMetadata) -> Self {
        Self {
            ...
            language: val.language,
            text_direction: val.text_direction.as_ref().map(|v| serde_json::to_value(v).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default()),
...
impl From<DocxMetadata> for kreuzberg::DocxMetadata {
    fn from(val: DocxMetadata) -> Self {
        Self {
            ...
            custom_properties: val.custom_properties.map(|m| m.into_iter().map(|(k, v)| (k, serde_json::from_str(&v).unwrap_or_default())).collect()),
        }
    }
}
...
impl From<kreuzberg::DocxMetadata> for DocxMetadata {
    fn from(val: kreuzberg::DocxMetadata) -> Self {
        Self {
            ...
            custom_properties: val.custom_properties.map(|m| m.into_iter().map(|(k, v)| (k, v.to_string())).collect()),
        }
    }
}
...
impl From<BibtexMetadata> for kreuzberg::BibtexMetadata {
    fn from(val: BibtexMetadata) -> Self {
        Self {
            ...
            entry_types: val.entry_types.map(|m| m.into_iter().map(|(k, v)| (k, v as usize)).collect()),
        }
    }
}
...
impl From<kreuzberg::BibtexMetadata> for BibtexMetadata {
    fn from(val: kreuzberg::BibtexMetadata) -> Self {
        Self {
            ...
            authors: val.authors,
            year_range: val.year_range.map(Into::into),
            entry_types: val.entry_types.as_ref().map(|m| m.iter().map(|(k, v)| (k.clone(), *v as i64)).collect()),
        }
    }
}
...
impl From<kreuzberg::OcrElement> for OcrElement {
    fn from(val: kreuzberg::OcrElement) -> Self {
        Self {
            ...
            backend_metadata: val.backend_metadata.into_iter().map(|(k, v)| (k, v.to_string())).collect(),
        }
    }
}
...
impl From<kreuzberg::OcrElementConfig> for OcrElementConfig {
    fn from(val: kreuzberg::OcrElementConfig) -> Self {
        Self {
            ...
            min_level: serde_json::to_value(val.min_level).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            min_confidence: val.min_confidence,
...
impl From<kreuzberg::PageStructure> for PageStructure {
    fn from(val: kreuzberg::PageStructure) -> Self {
        Self {
            ...
            unit_type: serde_json::to_value(val.unit_type).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            boundaries: val.boundaries.map(|v| v.into_iter().map(Into::into).collect()),
            pages: val.pages.map(|v| v.into_iter().map(Into::into).collect()),
        }
    }
...
impl From<kreuzberg::KeywordConfig> for KeywordConfig {
    fn from(val: kreuzberg::KeywordConfig) -> Self {
        Self {
            algorithm: serde_json::to_value(val.algorithm).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
...
impl From<kreuzberg::LayoutDetection> for LayoutDetection {
    fn from(val: kreuzberg::LayoutDetection) -> Self {
        Self {
            class_name: serde_json::to_value(val.class_name).ok().and_then(|s| s.as_str().map(String::from)).unwrap_or_default(),
            confidence: val.confidence,
            bbox: val.bbox.into(),
        }
    }
...
impl From<kreuzberg::ChunkSizing> for ChunkSizing {
    fn from(val: kreuzberg::ChunkSizing) -> Self {
        match val {
            ...
            kreuzberg::ChunkSizing::Tokenizer{ model, cache_dir } => Self { type_tag: "tokenizer".to_string(), model: Some(model.into()), cache_dir: cache_dir.map(Into::into), ..Default::default() },
        }
    }
}
...
impl From<kreuzberg::EmbeddingModelType> for EmbeddingModelType {
    fn from(val: kreuzberg::EmbeddingModelType) -> Self {
        match val {
            kreuzberg::EmbeddingModelType::Preset{ name } => Self { type_tag: "preset".to_string(), name: Some(name.into()), ..Default::default() },
            kreuzberg::EmbeddingModelType::Custom{ model_id, dimensions } => Self { type_tag: "custom".to_string(), model_id: Some(model_id.into()), dimensions: Some(dimensions.into()), ..Default::default() },
            kreuzberg::EmbeddingModelType::Llm{ llm } => Self { type_tag: "llm".to_string(), llm: Some(llm.into()), ..Default::default() },
            kreuzberg::EmbeddingModelType::Plugin{ name } => Self { type_tag: "plugin".to_string(), name: Some(name.into()), ..Default::default() },
        }
    }
}
...
impl From<kreuzberg::NodeContent> for NodeContent {
    fn from(val: kreuzberg::NodeContent) -> Self {
        match val {
            kreuzberg::NodeContent::Title{ text } => Self { node_type_tag: "title".to_string(), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::Heading{ level, text } => Self { node_type_tag: "heading".to_string(), level: Some(level.into()), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::Paragraph{ text } => Self { node_type_tag: "paragraph".to_string(), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::List{ ordered } => Self { node_type_tag: "list".to_string(), ordered: Some(ordered.into()), ..Default::default() },
            kreuzberg::NodeContent::ListItem{ text } => Self { node_type_tag: "list_item".to_string(), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::Table{ grid } => Self { node_type_tag: "table".to_string(), grid: Some(grid.into()), ..Default::default() },
            kreuzberg::NodeContent::Image{ description, image_index, src } => Self { node_type_tag: "image".to_string(), description: description.map(Into::into), image_index: image_index.map(Into::into), src: src.map(Into::into), ..Default::default() },
            kreuzberg::NodeContent::Code{ text, language } => Self { node_type_tag: "code".to_string(), text: Some(text.into()), language: language.map(Into::into), ..Default::default() },
            kreuzberg::NodeContent::Quote => Self { node_type_tag: "quote".to_string(), ..Default::default() },
            kreuzberg::NodeContent::Formula{ text } => Self { node_type_tag: "formula".to_string(), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::Footnote{ text } => Self { node_type_tag: "footnote".to_string(), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::Group{ label, heading_level, heading_text } => Self { node_type_tag: "group".to_string(), label: label.map(Into::into), heading_level: heading_level.map(Into::into), heading_text: heading_text.map(Into::into), ..Default::default() },
            kreuzberg::NodeContent::PageBreak => Self { node_type_tag: "page_break".to_string(), ..Default::default() },
            kreuzberg::NodeContent::Slide{ number, title } => Self { node_type_tag: "slide".to_string(), number: Some(number.into()), title: title.map(Into::into), ..Default::default() },
            kreuzberg::NodeContent::DefinitionList => Self { node_type_tag: "definition_list".to_string(), ..Default::default() },
            kreuzberg::NodeContent::DefinitionItem{ term, definition } => Self { node_type_tag: "definition_item".to_string(), term: Some(term.into()), definition: Some(definition.into()), ..Default::default() },
            kreuzberg::NodeContent::Citation{ key, text } => Self { node_type_tag: "citation".to_string(), key: Some(key.into()), text: Some(text.into()), ..Default::default() },
            kreuzberg::NodeContent::Admonition{ kind, title } => Self { node_type_tag: "admonition".to_string(), kind: Some(kind.into()), title: title.map(Into::into), ..Default::default() },
            kreuzberg::NodeContent::RawBlock{ format, content } => Self { node_type_tag: "raw_block".to_string(), format: Some(format.into()), content: Some(content.into()), ..Default::default() },
            kreuzberg::NodeContent::MetadataBlock{ entries } => Self { node_type_tag: "metadata_block".to_string(), entries: Some(entries.into()), ..Default::default() },
        }
    }
}
...
impl From<kreuzberg::AnnotationKind> for AnnotationKind {
    fn from(val: kreuzberg::AnnotationKind) -> Self {
        match val {
            ...
            kreuzberg::AnnotationKind::Link{ url, title } => Self { annotation_type_tag: "link".to_string(), url: Some(url.into()), title: title.map(Into::into), ..Default::default() },
            kreuzberg::AnnotationKind::Highlight => Self { annotation_type_tag: "highlight".to_string(), ..Default::default() },
            kreuzberg::AnnotationKind::Color{ value } => Self { annotation_type_tag: "color".to_string(), value: Some(value.into()), ..Default::default() },
            kreuzberg::AnnotationKind::FontSize{ value } => Self { annotation_type_tag: "font_size".to_string(), value: Some(value.into()), ..Default::default() },
            kreuzberg::AnnotationKind::Custom{ name, value } => Self { annotation_type_tag: "custom".to_string(), name: Some(name.into()), value: value.map(Into::into), ..Default::default() },
        }
    }
}
...
impl From<kreuzberg::FormatMetadata> for FormatMetadata {
    fn from(val: kreuzberg::FormatMetadata) -> Self {
        match val {
            kreuzberg::FormatMetadata::Pdf(_0) => Self { format_type_tag: "pdf".to_string(), pdf: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Docx(_0) => Self { format_type_tag: "docx".to_string(), docx: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Excel(_0) => Self { format_type_tag: "excel".to_string(), excel: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Email(_0) => Self { format_type_tag: "email".to_string(), email: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Pptx(_0) => Self { format_type_tag: "pptx".to_string(), pptx: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Archive(_0) => Self { format_type_tag: "archive".to_string(), archive: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Image(_0) => Self { format_type_tag: "image".to_string(), image: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Xml(_0) => Self { format_type_tag: "xml".to_string(), xml: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Text(_0) => Self { format_type_tag: "text".to_string(), text: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Html(_0) => Self { format_type_tag: "html".to_string(), html: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Ocr(_0) => Self { format_type_tag: "ocr".to_string(), ocr: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Csv(_0) => Self { format_type_tag: "csv".to_string(), csv: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Bibtex(_0) => Self { format_type_tag: "bibtex".to_string(), bibtex: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Citation(_0) => Self { format_type_tag: "citation".to_string(), citation: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::FictionBook(_0) => Self { format_type_tag: "fiction_book".to_string(), fiction_book: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Dbf(_0) => Self { format_type_tag: "dbf".to_string(), dbf: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Jats(_0) => Self { format_type_tag: "jats".to_string(), jats: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Epub(_0) => Self { format_type_tag: "epub".to_string(), epub: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Pst(_0) => Self { format_type_tag: "pst".to_string(), pst: Some(_0.into()), ..Default::default() },
            kreuzberg::FormatMetadata::Code(_0) => Self { format_type_tag: "code".to_string(), code: Some(_0.into()), ..Default::default() },
        }
    }
}
...
impl From<FormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: FormatMetadata) -> Self {
        match val.format_type_tag.as_str() {
            ...
            "docx" => kreuzberg::FormatMetadata::Docx( val.docx.map(Into::into).unwrap_or_default() ),
            ...
            "html" => kreuzberg::FormatMetadata::Html( val.html.map(Into::into).unwrap_or_default() ),
            ...
            "code" => kreuzberg::FormatMetadata::Code( val.code.map(Into::into).unwrap_or_default() ),
...
impl From<kreuzberg::OcrBoundingGeometry> for OcrBoundingGeometry {
    fn from(val: kreuzberg::OcrBoundingGeometry) -> Self {
        match val {
            kreuzberg::OcrBoundingGeometry::Rectangle{ left, top, width, height } => Self { type_tag: "rectangle".to_string(), left: Some(left.into()), top: Some(top.into()), width: Some(width.into()), height: Some(height.into()), ..Default::default() },
            kreuzberg::OcrBoundingGeometry::Quadrilateral{ points } => Self { type_tag: "quadrilateral".to_string(), points: Some(points.into()), ..Default::default() },
        }
    }
}
...
fn kreuzberg_error_to_php_err(e: kreuzberg::error::KreuzbergError) -> ext_php_rs::exception::PhpException {
    ...
    match &e {
        kreuzberg::error::KreuzbergError::Io(..) => ext_php_rs::exception::PhpException::default(format!("[Io] {}", msg)),
        kreuzberg::error::KreuzbergError::Parsing { .. } => ext_php_rs::exception::PhpException::default(format!("[Parsing] {}", msg)),
        kreuzberg::error::KreuzbergError::Ocr { .. } => ext_php_rs::exception::PhpException::default(format!("[Ocr] {}", msg)),
        kreuzberg::error::KreuzbergError::Validation { .. } => ext_php_rs::exception::PhpException::default(format!("[Validation] {}", msg)),
        kreuzberg::error::KreuzbergError::Cache { .. } => ext_php_rs::exception::PhpException::default(format!("[Cache] {}", msg)),
        kreuzberg::error::KreuzbergError::ImageProcessing { .. } => ext_php_rs::exception::PhpException::default(format!("[ImageProcessing] {}", msg)),
        kreuzberg::error::KreuzbergError::Serialization { .. } => ext_php_rs::exception::PhpException::default(format!("[Serialization] {}", msg)),
        kreuzberg::error::KreuzbergError::MissingDependency(..) => ext_php_rs::exception::PhpException::default(format!("[MissingDependency] {}", msg)),
        kreuzberg::error::KreuzbergError::Plugin { .. } => ext_php_rs::exception::PhpException::default(format!("[Plugin] {}", msg)),
        kreuzberg::error::KreuzbergError::LockPoisoned(..) => ext_php_rs::exception::PhpException::default(format!("[LockPoisoned] {}", msg)),
        kreuzberg::error::KreuzbergError::UnsupportedFormat(..) => ext_php_rs::exception::PhpException::default(format!("[UnsupportedFormat] {}", msg)),
        kreuzberg::error::KreuzbergError::Embedding { .. } => ext_php_rs::exception::PhpException::default(format!("[Embedding] {}", msg)),
        kreuzberg::error::KreuzbergError::Timeout { .. } => ext_php_rs::exception::PhpException::default(format!("[Timeout] {}", msg)),
        kreuzberg::error::KreuzbergError::Cancelled => ext_php_rs::exception::PhpException::default(format!("[Cancelled] {}", msg)),
        kreuzberg::error::KreuzbergError::Security { .. } => ext_php_rs::exception::PhpException::default(format!("[Security] {}", msg)),
        kreuzberg::error::KreuzbergError::Other(..) => ext_php_rs::exception::PhpException::default(format!("[Other] {}", msg)),
