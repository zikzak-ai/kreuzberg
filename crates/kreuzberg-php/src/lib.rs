...
// alef:hash:8f2fe66e6f8cdde41404bb0d1474454f43dc8d803cb55f59de6c4a6efe293525
...
pub struct BatchBytesItem {
    /// The content bytes to extract from (stored as String in PHP)
    pub content: String,
...
pub struct SecurityLimits {
    ...
    #[serde(default = "crate::serde_defaults::security_max_archive_size")]
    ...
    #[serde(default = "crate::serde_defaults::security_max_entity_length")]
    pub max_entity_length: i64,
    /// Maximum string growth per document (100 MB)
    #[php(prop, name = "maxContentSize")]
    #[serde(default = "crate::serde_defaults::security_max_content_size")]
    pub max_content_size: i64,
    /// Maximum iterations per operation
    #[php(prop, name = "maxIterations")]
    #[serde(default = "crate::serde_defaults::security_max_iterations")]
    pub max_iterations: i64,
    /// Maximum XML depth (100 levels)
    #[php(prop, name = "maxXmlDepth")]
    #[serde(default = "crate::serde_defaults::security_max_xml_depth")]
    pub max_xml_depth: i64,
    /// Maximum cells per table (100,000)
    #[php(prop, name = "maxTableCells")]
    #[serde(default = "crate::serde_defaults::security_max_table_cells")]
...
impl From<BatchBytesItem> for kreuzberg::BatchBytesItem {
    fn from(val: BatchBytesItem) -> Self {
        Self {
            content: val.content.into_bytes(),
...
impl From<kreuzberg::BatchBytesItem> for BatchBytesItem {
    fn from(val: kreuzberg::BatchBytesItem) -> Self {
        Self {
            content: String::from_utf8_lossy(&val.content).into_owned(),
            mime_type: val.mime_type,
            config: val.config.map(Into::into),
        }
    }
...
mod serde_defaults {
    ...
    pub fn security_max_archive_size() -> i64 {
        500 * 1024 * 1024
    }

    pub fn security_max_compression_ratio() -> i64 {
        100
    }

    pub fn security_max_files_in_archive() -> i64 {
        10_000
    }

    pub fn security_max_nesting_depth() -> i64 {
        1024
    }

    pub fn security_max_entity_length() -> i64 {
        1024 * 1024
    }

    pub fn security_max_content_size() -> i64 {
        100 * 1024 * 1024
    }

    pub fn security_max_iterations() -> i64 {
        10_000_000
    }

    pub fn security_max_xml_depth() -> i64 {
        1024
    }

    pub fn security_max_table_cells() -> i64 {
        100_000
    }
}
