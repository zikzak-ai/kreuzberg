...
// alef:hash:2984d71ed9f51bb0528dcd932a6e3c81c7ca497f03f5205556ce5bee9bf90eaa
...
impl Metadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (additional=None, title=None, subject=None, authors=None, keywords=None, language=None, created_at=None, modified_at=None, created_by=None, modified_by=None, pages=None, format=None, image_preprocessing=None, json_schema=None, error=None, extraction_duration_ms=None, category=None, tags=None, document_version=None, abstract_text=None, output_format=None, extraction_method=None))]
    #[new]
    pub fn new(
...
impl ExcelMetadata {
    #[must_use]
    #[pyo3(signature = (sheet_count=None, sheet_names=None, custom_properties=None))]
    #[new]
    pub fn new(
...
impl EmailMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (to_emails=None, cc_emails=None, bcc_emails=None, attachments=None, from_email=None, from_name=None, message_id=None, extra_headers=None))]
    #[new]
    pub fn new(
...
impl ArchiveFileEntry {
    #[must_use]
    #[pyo3(signature = (path=None, size=None, is_dir=None))]
    #[new]
    pub fn new(path: Option<String>, size: Option<u64>, is_dir: Option<bool>) -> Self {
        Self {
...
impl ArchiveMetadata {
    #[must_use]
    #[pyo3(signature = (format=None, file_count=None, entries=None, total_size=None, compressed_size=None))]
    #[new]
    pub fn new(
        format: Option<String>,
        file_count: Option<usize>,
        entries: Option<Vec<ArchiveFileEntry>>,
...
impl PptxMetadata {
    #[must_use]
    #[pyo3(signature = (slide_count=None, slide_names=None, image_count=None, table_count=None, custom_properties=None))]
    #[new]
    pub fn new(
...
impl StructuredMetadata {
    #[must_use]
    #[pyo3(signature = (data_format=None, field_count=None, custom_fields=None))]
    #[new]
    pub fn new(
        ...
        Self {
            data_format: data_format.unwrap_or_default(),
...
impl BibtexMetadata {
    #[must_use]
    #[pyo3(signature = (entry_count=None, citation_keys=None, authors=None, year_range=None, entry_types=None, entries=None))]
    #[new]
    pub fn new(
...
impl FormatMetadata {
    ...
    #[getter]
    fn structured(&self) -> Option<StructuredMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Structured(data) => Some(data.clone().into()),
            _ => None,
        }
    }
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<StructuredMetadata>()?;
