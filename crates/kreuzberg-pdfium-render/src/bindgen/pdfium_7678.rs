...
pub struct FPDF_FILEHANDLER_ {
    ...
    pub Release: ::std::option::Option<unsafe extern "C" fn(clientData: *mut ::std::os::raw::c_void)>,
    #[doc = " Callback function to retrieve the current file stream size.\n\n Parameters:\n       clientData   -  Pointer to user-defined data.\n Returns:\n       Size of file stream."]
    pub GetSize: ::std::option::Option<unsafe extern "C" fn(clientData: *mut ::std::os::raw::c_void) -> FPDF_DWORD>,
    ...
    pub Flush: ::std::option::Option<unsafe extern "C" fn(clientData: *mut ::std::os::raw::c_void) -> FPDF_RESULT>,
    ...
    pub Truncate: ::std::option::Option<
        unsafe extern "C" fn(clientData: *mut ::std::os::raw::c_void, size: FPDF_DWORD) -> FPDF_RESULT,
    >,
}
#[doc = " Structure for file reading or writing (I/O).\n\n Note: This is a handler and should be implemented by callers,\n and is only used from XFA."]
...
unsafe extern "C" {
    ...
    pub fn FPDF_LoadCustomDocument(pFileAccess: *mut FPDF_FILEACCESS, password: FPDF_BYTESTRING) -> FPDF_DOCUMENT;
}
unsafe extern "C" {
    ...
    pub fn FPDF_GetFileVersion(doc: FPDF_DOCUMENT, fileVersion: *mut ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_VIEWERREF_GetPrintPageRangeElement(pagerange: FPDF_PAGERANGE, index: usize) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_GetMarkedContentID(struct_element: FPDF_STRUCTELEMENT) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_CountChildren(struct_element: FPDF_STRUCTELEMENT) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_GetAttributeCount(struct_element: FPDF_STRUCTELEMENT) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_Attr_GetCount(struct_attribute: FPDF_STRUCTELEMENT_ATTR) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_Attr_GetType(value: FPDF_STRUCTELEMENT_ATTR_VALUE) -> FPDF_OBJECT_TYPE;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_Attr_CountChildren(value: FPDF_STRUCTELEMENT_ATTR_VALUE) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_StructElement_GetMarkedContentIdCount(struct_element: FPDF_STRUCTELEMENT) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFText_GetUnicode(text_page: FPDF_TEXTPAGE, index: ::std::os::raw::c_int) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    ...
    pub fn FPDFText_GetTextObject(text_page: FPDF_TEXTPAGE, index: ::std::os::raw::c_int) -> FPDF_PAGEOBJECT;
}
unsafe extern "C" {
    ...
    pub fn FPDFText_IsGenerated(text_page: FPDF_TEXTPAGE, index: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn FPDFText_IsHyphen(text_page: FPDF_TEXTPAGE, index: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    ...
    pub fn FPDFText_HasUnicodeMapError(text_page: FPDF_TEXTPAGE, index: ::std::os::raw::c_int)
    -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFText_GetFontWeight(text_page: FPDF_TEXTPAGE, index: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFLink_CountRects(link_page: FPDF_PAGELINK, link_index: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFDest_GetDestPageIndex(document: FPDF_DOCUMENT, dest: FPDF_DEST) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPage_InsertObjectAtIndex(page: FPDF_PAGE, page_object: FPDF_PAGEOBJECT, index: usize) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_GetIsActive(page_object: FPDF_PAGEOBJECT, active: *mut FPDF_BOOL) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_Transform(page_object: FPDF_PAGEOBJECT, a: f64, b: f64, c: f64, d: f64, e: f64, f: f64);
}
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_TransformF(page_object: FPDF_PAGEOBJECT, matrix: *const FS_MATRIX) -> FPDF_BOOL;
}
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_GetMatrix(page_object: FPDF_PAGEOBJECT, matrix: *mut FS_MATRIX) -> FPDF_BOOL;
}
unsafe extern "C" {
    #[doc = " Experimental API.\n Set the transform matrix of a page object.\n\n   page_object - handle to a page object.\n   matrix      - pointer to struct with the matrix value.\n\n The matrix is composed as:\n   |a c e|\n   |b d f|\n and can be used to scale, rotate, shear and translate the page object.\n\n Returns TRUE on success."]
    pub fn FPDFPageObj_SetMatrix(page_object: FPDF_PAGEOBJECT, matrix: *const FS_MATRIX) -> FPDF_BOOL;
}
unsafe extern "C" {
    #[doc = " Transform all annotations in |page|.\n\n   page - handle to a page.\n   a    - matrix value.\n   b    - matrix value.\n   c    - matrix value.\n   d    - matrix value.\n   e    - matrix value.\n   f    - matrix value.\n\n The matrix is composed as:\n   |a c e|\n   |b d f|\n and can be used to scale, rotate, shear and translate the |page| annotations."]
    pub fn FPDFPage_TransformAnnots(page: FPDF_PAGE, a: f64, b: f64, c: f64, d: f64, e: f64, f: f64);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_GetMark(page_object: FPDF_PAGEOBJECT, index: ::std::os::raw::c_ulong) -> FPDF_PAGEOBJECTMARK;
}
unsafe extern "C" {
    #[doc = " Experimental API.\n Add a new content mark to a |page_object|.\n\n   page_object - handle to a page object.\n   name        - the name (tag) of the mark.\n\n Returns the handle to the content mark, or NULL on failure. The handle is\n still owned by the library, and it should not be freed directly. It becomes\n invalid if the page object is destroyed, either directly or indirectly by\n unloading the page."]
    pub fn FPDFPageObj_AddMark(page_object: FPDF_PAGEOBJECT, name: FPDF_BYTESTRING) -> FPDF_PAGEOBJECTMARK;
}
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_RemoveMark(page_object: FPDF_PAGEOBJECT, mark: FPDF_PAGEOBJECTMARK) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObjMark_GetParamValueType(mark: FPDF_PAGEOBJECTMARK, key: FPDF_BYTESTRING) -> FPDF_OBJECT_TYPE;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFImageObj_GetImageFilterCount(image_object: FPDF_PAGEOBJECT) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_GetRotatedBounds(page_object: FPDF_PAGEOBJECT, quad_points: *mut FS_QUADPOINTSF) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_SetLineJoin(page_object: FPDF_PAGEOBJECT, line_join: ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_SetLineCap(page_object: FPDF_PAGEOBJECT, line_cap: ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_GetDashArray(page_object: FPDF_PAGEOBJECT, dash_array: *mut f32, dash_count: usize)
    -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPath_GetPathSegment(path: FPDF_PAGEOBJECT, index: ::std::os::raw::c_int) -> FPDF_PATHSEGMENT;
}
unsafe extern "C" {
    ...
    pub fn FPDFPathSegment_GetPoint(segment: FPDF_PATHSEGMENT, x: *mut f32, y: *mut f32) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPath_BezierTo(path: FPDF_PAGEOBJECT, x1: f32, y1: f32, x2: f32, y2: f32, x3: f32, y3: f32) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPath_SetDrawMode(path: FPDF_PAGEOBJECT, fillmode: ::std::os::raw::c_int, stroke: FPDF_BOOL)
    -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_NewTextObj(document: FPDF_DOCUMENT, font: FPDF_BYTESTRING, font_size: f32) -> FPDF_PAGEOBJECT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFText_SetCharcodes(text_object: FPDF_PAGEOBJECT, charcodes: *const u32, count: usize) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_CreateTextObj(document: FPDF_DOCUMENT, font: FPDF_FONT, font_size: f32) -> FPDF_PAGEOBJECT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFTextObj_SetTextRenderMode(text: FPDF_PAGEOBJECT, render_mode: FPDF_TEXT_RENDERMODE) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFFont_GetBaseFontName(font: FPDF_FONT, buffer: *mut ::std::os::raw::c_char, length: usize) -> usize;
}
unsafe extern "C" {
    ...
    pub fn FPDFFont_GetFamilyName(font: FPDF_FONT, buffer: *mut ::std::os::raw::c_char, length: usize) -> usize;
}
unsafe extern "C" {
    ...
    pub fn FPDFFont_GetFontData(font: FPDF_FONT, buffer: *mut u8, buflen: usize, out_buflen: *mut usize) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFFont_GetItalicAngle(font: FPDF_FONT, angle: *mut ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFFont_GetGlyphWidth(font: FPDF_FONT, glyph: u32, font_size: f32, width: *mut f32) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFFormObj_GetObject(form_object: FPDF_PAGEOBJECT, index: ::std::os::raw::c_ulong) -> FPDF_PAGEOBJECT;
}
unsafe extern "C" {
    ...
    pub fn FPDFFormObj_RemoveObject(form_object: FPDF_PAGEOBJECT, page_object: FPDF_PAGEOBJECT) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPageObj_TransformClipPath(page_object: FPDF_PAGEOBJECT, a: f64, b: f64, c: f64, d: f64, e: f64, f: f64);
}
unsafe extern "C" {
...
pub struct _IPDF_JsPlatform {
    ...
    pub app_beep:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _IPDF_JsPlatform, nType: ::std::os::raw::c_int)>,
    ...
    pub Doc_gotoPage:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _IPDF_JsPlatform, nPageNum: ::std::os::raw::c_int)>,
...
pub type TimerCallback = ::std::option::Option<unsafe extern "C" fn(idEvent: ::std::os::raw::c_int)>;
...
pub struct _FPDF_FORMFILLINFO {
    ...
    pub FFI_SetCursor:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, nCursorType: ::std::os::raw::c_int)>,
    ...
    pub FFI_KillTimer:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, nTimerID: ::std::os::raw::c_int)>,
    ...
    pub FFI_GetLocalTime:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO) -> FPDF_SYSTEMTIME>,
    ...
    pub FFI_GetRotation: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, page: FPDF_PAGE) -> ::std::os::raw::c_int,
    >,
    ...
    pub FFI_ExecuteNamedAction:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, namedAction: FPDF_BYTESTRING)>,
    ...
    pub FFI_DoURIAction:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, bsURI: FPDF_BYTESTRING)>,
    ...
    pub FFI_GetCurrentPageIndex: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, document: FPDF_DOCUMENT) -> ::std::os::raw::c_int,
    >,
    ...
    pub FFI_SetCurrentPage: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, document: FPDF_DOCUMENT, iCurPage: ::std::os::raw::c_int),
    >,
    ...
    pub FFI_GotoURL: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, document: FPDF_DOCUMENT, wsURL: FPDF_WIDESTRING),
    >,
    ...
    pub FFI_PageEvent: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, page_count: ::std::os::raw::c_int, event_type: FPDF_DWORD),
    >,
    ...
    pub FFI_DownloadFromURL: ::std::option::Option<
        unsafe extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, URL: FPDF_WIDESTRING) -> *mut FPDF_FILEHANDLER,
    >,
    ...
    pub FFI_OnFocusChange: ::std::option::Option<
        unsafe extern "C" fn(param: *mut _FPDF_FORMFILLINFO, annot: FPDF_ANNOTATION, page_index: ::std::os::raw::c_int),
    >,
    ...
    pub FFI_DoURIActionWithKeyboardModifier: ::std::option::Option<
        unsafe extern "C" fn(param: *mut _FPDF_FORMFILLINFO, uri: FPDF_BYTESTRING, modifiers: ::std::os::raw::c_int),
    >,
}
...
unsafe extern "C" {
    ...
    pub fn FORM_DoPageAAction(page: FPDF_PAGE, hHandle: FPDF_FORMHANDLE, aaType: ::std::os::raw::c_int);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FORM_ReplaceAndKeepSelection(hHandle: FPDF_FORMHANDLE, page: FPDF_PAGE, wsText: FPDF_WIDESTRING);
}
unsafe extern "C" {
    #[doc = " Function: FORM_ReplaceSelection\n       Call this function to replace the selected text in a form\n       text field or user-editable form combobox text field with another\n       text string (which can be empty or non-empty). If there is no\n       selected text, this function will append the replacement text after\n       the current caret position. After the insertion, the selection range\n       will be set to empty.\n Parameters:\n       hHandle     -   Handle to the form fill module, as returned by\n                       FPDFDOC_InitFormFillEnvironment().\n       page        -   Handle to the page, as Returned by FPDF_LoadPage().\n       wsText      -   The text to be inserted, in UTF-16LE format.\n Return Value:\n       None."]
    pub fn FORM_ReplaceSelection(hHandle: FPDF_FORMHANDLE, page: FPDF_PAGE, wsText: FPDF_WIDESTRING);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_SetFormFieldHighlightAlpha(hHandle: FPDF_FORMHANDLE, alpha: ::std::os::raw::c_uchar);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FORM_IsIndexSelected(hHandle: FPDF_FORMHANDLE, page: FPDF_PAGE, index: ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPage_CreateAnnot(page: FPDF_PAGE, subtype: FPDF_ANNOTATION_SUBTYPE) -> FPDF_ANNOTATION;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFPage_GetAnnotIndex(page: FPDF_PAGE, annot: FPDF_ANNOTATION) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetObject(annot: FPDF_ANNOTATION, index: ::std::os::raw::c_int) -> FPDF_PAGEOBJECT;
}
unsafe extern "C" {
    #[doc = " Experimental API.\n Remove the object in |annot| at |index|.\n\n   annot  - handle to an annotation.\n   index  - the index of the object to be removed.\n\n Return true if successful."]
    pub fn FPDFAnnot_RemoveObject(annot: FPDF_ANNOTATION, index: ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_AppendAttachmentPoints(annot: FPDF_ANNOTATION, quad_points: *const FS_QUADPOINTSF) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetLine(annot: FPDF_ANNOTATION, start: *mut FS_POINTF, end: *mut FS_POINTF) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetValueType(annot: FPDF_ANNOTATION, key: FPDF_BYTESTRING) -> FPDF_OBJECT_TYPE;
}
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_SetStringValue(annot: FPDF_ANNOTATION, key: FPDF_BYTESTRING, value: FPDF_WIDESTRING) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetNumberValue(annot: FPDF_ANNOTATION, key: FPDF_BYTESTRING, value: *mut f32) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetLinkedAnnot(annot: FPDF_ANNOTATION, key: FPDF_BYTESTRING) -> FPDF_ANNOTATION;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetFormFieldFlags(handle: FPDF_FORMHANDLE, annot: FPDF_ANNOTATION) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetFormFieldType(hHandle: FPDF_FORMHANDLE, annot: FPDF_ANNOTATION) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetOptionCount(hHandle: FPDF_FORMHANDLE, annot: FPDF_ANNOTATION) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetFontSize(hHandle: FPDF_FORMHANDLE, annot: FPDF_ANNOTATION, value: *mut f32) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_GetFormControlCount(hHandle: FPDF_FORMHANDLE, annot: FPDF_ANNOTATION) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Experimental API.\n Gets the index of |annot| in |annot|'s control group.\n A group of interactive form annotations is collectively called a form\n control group. Here, |annot|, an interactive form annotation, should be\n either a radio button or a checkbox.\n\n   hHandle - handle to the form fill module, returned by\n             FPDFDOC_InitFormFillEnvironment.\n   annot   - handle to an annotation.\n\n Returns index of a given |annot| in its control group or -1 on error."]
    pub fn FPDFAnnot_GetFormControlIndex(hHandle: FPDF_FORMHANDLE, annot: FPDF_ANNOTATION) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_SetURI(annot: FPDF_ANNOTATION, uri: *const ::std::os::raw::c_char) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAnnot_AddFileAttachment(annot: FPDF_ANNOTATION, name: FPDF_WIDESTRING) -> FPDF_ATTACHMENT;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_CopyViewerPreferences(dest_doc: FPDF_DOCUMENT, src_doc: FPDF_DOCUMENT) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFDoc_GetJavaScriptAction(document: FPDF_DOCUMENT, index: ::std::os::raw::c_int)
...
unsafe extern "C" {
    ...
    pub fn FPDFPage_Flatten(page: FPDF_PAGE, nFlag: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
...
unsafe extern "C" {
    ...
    pub fn FPDF_SaveAsCopy(document: FPDF_DOCUMENT, pFileWrite: *mut FPDF_FILEWRITE, flags: FPDF_DWORD) -> FPDF_BOOL;
}
unsafe extern "C" {
...
pub struct _FPDF_SYSFONTINFO {
    ...
    pub DeleteFont:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FPDF_SYSFONTINFO, hFont: *mut ::std::os::raw::c_void)>,
}
#[doc = " Interface: FPDF_SYSFONTINFO\n          Interface for getting system font information and font mapping"]
...
unsafe extern "C" {
    ...
    pub fn FPDFDoc_AddAttachment(document: FPDF_DOCUMENT, name: FPDF_WIDESTRING) -> FPDF_ATTACHMENT;
}
unsafe extern "C" {
    ...
    pub fn FPDFDoc_GetAttachment(document: FPDF_DOCUMENT, index: ::std::os::raw::c_int) -> FPDF_ATTACHMENT;
}
unsafe extern "C" {
    ...
    pub fn FPDFDoc_DeleteAttachment(document: FPDF_DOCUMENT, index: ::std::os::raw::c_int) -> FPDF_BOOL;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAttachment_GetValueType(attachment: FPDF_ATTACHMENT, key: FPDF_BYTESTRING) -> FPDF_OBJECT_TYPE;
}
unsafe extern "C" {
...
#[derive(Debug, Copy, Clone)]
pub struct tm {
    #[doc = " seconds after the minute [0-60]"]
    ...
    #[doc = " days since January 1 [0-365]"]
    pub tm_yday: ::std::os::raw::c_int,
    #[doc = " Daylight Savings Time flag"]
...
pub struct _UNSUPPORT_INFO {
    ...
    pub FSDK_UnSupport_Handler:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _UNSUPPORT_INFO, nType: ::std::os::raw::c_int)>,
}
#[doc = " Interface for unsupported feature notifications."]
...
unsafe extern "C" {
    ...
    pub fn FSDK_SetLocaltimeFunction(func: ::std::option::Option<unsafe extern "C" fn(arg1: *const time_t) -> *mut tm>);
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDF_GetSignatureObject(document: FPDF_DOCUMENT, index: ::std::os::raw::c_int) -> FPDF_SIGNATURE;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFSignatureObj_GetDocMDPPermission(signature: FPDF_SIGNATURE) -> ::std::os::raw::c_uint;
}
...
pub struct _IFSDK_PAUSE {
    ...
    pub NeedToPauseNow: ::std::option::Option<unsafe extern "C" fn(pThis: *mut _IFSDK_PAUSE) -> FPDF_BOOL>,
...
unsafe extern "C" {
    ...
    pub fn FPDF_RenderPage_Continue(page: FPDF_PAGE, pause: *mut IFSDK_PAUSE) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
pub struct _FX_FILEAVAIL {
    ...
    pub IsDataAvail:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FX_FILEAVAIL, offset: usize, size: usize) -> FPDF_BOOL>,
}
#[doc = " Interface for checking whether sections of the file are available."]
...
unsafe extern "C" {
    ...
    pub fn FPDFAvail_Create(file_avail: *mut FX_FILEAVAIL, file: *mut FPDF_FILEACCESS) -> FPDF_AVAIL;
}
unsafe extern "C" {
...
pub struct _FX_DOWNLOADHINTS {
    ...
    pub AddSegment:
        ::std::option::Option<unsafe extern "C" fn(pThis: *mut _FX_DOWNLOADHINTS, offset: usize, size: usize)>,
}
#[doc = " Download hints interface. Used to receive hints for further downloading."]
...
unsafe extern "C" {
    ...
    pub fn FPDFAvail_IsDocAvail(avail: FPDF_AVAIL, hints: *mut FX_DOWNLOADHINTS) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn FPDFAvail_IsFormAvail(avail: FPDF_AVAIL, hints: *mut FX_DOWNLOADHINTS) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
