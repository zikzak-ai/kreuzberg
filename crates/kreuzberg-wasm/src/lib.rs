...
// alef:hash:0f04d0c4a7bcc56d22325e60ef7df61d35a4973c03a27646fc4eda4a7d86848e
...
impl WasmEmailMetadata {
    ...
    #[wasm_bindgen(getter, js_name = "extraHeaders")]
    pub fn extra_headers(&self) -> Option<JsValue> {
        self.extra_headers.clone()
    }

    #[wasm_bindgen(setter, js_name = "extraHeaders")]
    pub fn set_extra_headers(&mut self, value: Option<JsValue>) {
...
#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmArchiveFileEntry {
    path: String,
    size: u64,
    is_dir: bool,
}
...
#[wasm_bindgen]
impl WasmArchiveFileEntry {
    #[wasm_bindgen(constructor)]
    pub fn new(path: Option<String>, size: Option<u64>, is_dir: Option<bool>) -> WasmArchiveFileEntry {
        WasmArchiveFileEntry {
...
pub struct WasmArchiveMetadata {
    format: String,
    file_count: usize,
    entries: Vec<WasmArchiveFileEntry>,
    total_size: usize,
...
impl WasmArchiveMetadata {
    ...
    pub fn new(
        ...
        entries: Option<Vec<WasmArchiveFileEntry>>,
    ...
    #[wasm_bindgen(getter)]
    pub fn entries(&self) -> Vec<WasmArchiveFileEntry> {
        self.entries.clone()
    }

    #[wasm_bindgen(setter)]
    pub fn set_entries(&mut self, value: Vec<WasmArchiveFileEntry>) {
        self.entries = value;
    }
...
#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmStructuredMetadata {
    data_format: String,
    field_count: usize,
...
#[wasm_bindgen]
impl WasmStructuredMetadata {
    #[wasm_bindgen(constructor)]
    pub fn new(
        data_format: Option<String>,
        field_count: Option<usize>,
        custom_fields: Option<JsValue>,
    ) -> WasmStructuredMetadata {
        WasmStructuredMetadata {
    ...
    #[wasm_bindgen(getter, js_name = "dataFormat")]
    pub fn data_format(&self) -> String {
        self.data_format.clone()
    }

    #[wasm_bindgen(setter, js_name = "dataFormat")]
    ...
    #[wasm_bindgen(getter, js_name = "customFields")]
    pub fn custom_fields(&self) -> Option<JsValue> {
        self.custom_fields.clone()
    }

    #[wasm_bindgen(setter, js_name = "customFields")]
    pub fn set_custom_fields(&mut self, value: Option<JsValue>) {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmArchiveFileEntry> for kreuzberg::ArchiveFileEntry {
    fn from(val: WasmArchiveFileEntry) -> Self {
        Self {
            path: val.path,
            size: val.size,
            is_dir: val.is_dir,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::ArchiveFileEntry> for WasmArchiveFileEntry {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmStructuredMetadata> for kreuzberg::StructuredMetadata {
    fn from(val: WasmStructuredMetadata) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::StructuredMetadata> for WasmStructuredMetadata {
    ...
    fn from(val: kreuzberg::BibtexMetadata) -> Self {
        Self {
            ...
            entry_types: val
                ...
                .and_then(|v| serde_json::to_string(v).ok())
                .and_then(|s| js_sys::JSON::parse(&s).ok()),
            entries: val.entries.as_ref().and_then(|v| serde_wasm_bindgen::to_value(v).ok()),
        }
    }
}
...
impl From<WasmFormatMetadata> for kreuzberg::FormatMetadata {
    fn from(val: WasmFormatMetadata) -> Self {
        match val {
            ...
            WasmFormatMetadata::Structured => Self::Structured(Default::default()),
...
impl From<kreuzberg::FormatMetadata> for WasmFormatMetadata {
    fn from(val: kreuzberg::FormatMetadata) -> Self {
        match val {
            ...
            kreuzberg::FormatMetadata::Structured(..) => Self::Structured,
