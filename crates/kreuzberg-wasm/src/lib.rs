...
// alef:hash:b0ef04a29286f06a508c91ce2e4e738ae4f76cd0287afe6313f9d89cc626c9a1
...
#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmArchiveArchiveMetadata {
    format: String,
    file_list: Vec<WasmArchiveEntry>,
    file_count: usize,
    total_size: u64,
}

#[wasm_bindgen]
impl WasmArchiveArchiveMetadata {
    #[wasm_bindgen(constructor)]
    pub fn new(
        format: String,
        file_list: Vec<WasmArchiveEntry>,
    ...
    pub fn file_list(&self) -> Vec<WasmArchiveEntry> {
        self.file_list.clone()
    }

    #[wasm_bindgen(setter, js_name = "fileList")]
    pub fn set_file_list(&mut self, value: Vec<WasmArchiveEntry>) {
...
#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmArchiveArchiveEntry {
    path: String,
    size: u64,
    is_dir: bool,
}
...
#[wasm_bindgen]
impl WasmArchiveArchiveEntry {
    #[wasm_bindgen(constructor)]
    pub fn new(path: String, size: u64, is_dir: bool) -> WasmArchiveArchiveEntry {
        WasmArchiveArchiveEntry { path, size, is_dir }
    }
    ...
    #[wasm_bindgen(getter, js_name = "isDir")]
    pub fn is_dir(&self) -> bool {
        self.is_dir
    }

    #[wasm_bindgen(setter, js_name = "isDir")]
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::extraction::archive::ArchiveMetadata> for WasmArchiveArchiveMetadata {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::extraction::archive::ArchiveEntry> for WasmArchiveArchiveEntry {
