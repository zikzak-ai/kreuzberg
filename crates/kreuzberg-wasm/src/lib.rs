...
// alef:hash:ed8cb86bfe27f2ac4feb543f14951a473c5c256a3b9661937dbe43eccfe81f9f
...
#[derive(Clone, Default)]
#[wasm_bindgen]
pub struct WasmEmbeddingPreset {
    name: String,
    chunk_size: usize,
    overlap: usize,
    model_repo: String,
...
impl WasmEmbeddingPreset {
    ...
    #[wasm_bindgen(getter, js_name = "modelRepo")]
    pub fn model_repo(&self) -> String {
        self.model_repo.clone()
    }

    #[wasm_bindgen(setter, js_name = "modelRepo")]
    pub fn set_model_repo(&mut self, value: String) {
    ...
    #[wasm_bindgen(setter)]
    pub fn set_pooling(&mut self, value: String) {
        self.pooling = value;
    }
    ...
    pub fn set_model_file(&mut self, value: String) {
...
pub fn get_embedding_preset(name: String) -> Option<WasmEmbeddingPreset> {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmEmbeddingPreset> for kreuzberg::EmbeddingPreset {
    fn from(val: WasmEmbeddingPreset) -> Self {
        Self {
            name: val.name,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::EmbeddingPreset> for WasmEmbeddingPreset {
