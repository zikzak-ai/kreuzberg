...
## Go API Reference <span class="version-badge">v4.9.2</span>
...
| `Members` | `[]string` | — | The text blocks that belong to this cluster |
...
| `NewDimensions` | `*string` | `nil` | New dimensions after resizing (if resized) |
