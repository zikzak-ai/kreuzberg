...
fn html_output_config() -> kreuzberg.HtmlOutputConfig {
  kreuzberg.HtmlOutputConfig(
    css: option.None,
    css_file: option.None,
    theme: kreuzberg.GitHub,
    class_prefix: "kb-",
    embed_css: True,
  )
}
...
fn config() -> kreuzberg.ExtractionConfig {
  kreuzberg.ExtractionConfig(
    ...
    html_output: option.Some(html_output_config()),
    ...
    output_format: kreuzberg.OutputFormatHtml,
    layout: option.None,
