...
// Note: the Gleam binding does not expose TOML/YAML/JSON config-file
// auto-discovery — build the `ExtractionConfig` programmatically and call
// `extract_file_sync` (or the async variant) with it.
